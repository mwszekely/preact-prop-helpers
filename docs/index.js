...
function I$1(n) {
  if (n.__P && n.__d) {
    var u = n.__v,
      ...
      r = [],
      o = m$1({}, u);
    o.__v = u.__v + 1, l$1.vnode && l$1.vnode(o), q$2(n.__P, o, u, n.__n, n.__P.namespaceURI, 32 & u.__u ? [t] : null, i, null == t ? $(u) : t, !!(32 & u.__u), r), o.__v = u.__v, o.__.__k[o.__i] = o, D$1(i, o, r), u.__e = u.__ = null, o.__e != t && P$1(o);
  }
}
function P$1(n) {
...
function T$2(n, l, u, t, i) {
  var r,
    ...
    a = s,
    h = 0;
  for (n.__k = new Array(i), r = 0; r < i; r++) null != (o = l[r]) && "boolean" != typeof o && "function" != typeof o ? ("string" == typeof o || "number" == typeof o || "bigint" == typeof o || o.constructor == String ? o = n.__k[r] = x$1(null, o, null, null, null) : g$1(o) ? o = n.__k[r] = x$1(S, {
    children: o
  }, null, null, null) : void 0 === o.constructor && o.__b > 0 ? o = n.__k[r] = x$1(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : n.__k[r] = o, f = r + h, o.__ = n, o.__b = n.__b + 1, e = null, -1 != (c = o.__i = O$1(o, u, f, a)) && (a--, (e = u[c]) && (e.__u |= 2)), null == e || null == e.__v ? (-1 == c && (i > s ? h-- : i < s && h++), "function" != typeof o.type && (o.__u |= 4)) : c != f && (c == f - 1 ? h-- : c == f + 1 ? h++ : (c > f ? h-- : h++, o.__u |= 4))) : n.__k[r] = null;
  if (a) for (r = 0; r < s; r++) null != (e = u[r]) && 0 == (2 & e.__u) && (e.__e == t && (t = $(e)), K$1(e, e));
  return t;
}
...
function F(n, l) {
  return l = l || [], null == n || "boolean" == typeof n || (g$1(n) ? n.some(function (n) {
    F(n, l);
  }) : l.push(n)), l;
}
...
function q$2(n, u, t, i, r, o, e, f, c, s) {
  ...
  n: if ("function" == typeof T) try {
    ...
    h.state = h.__s, null != h.getChildContext && (i = m$1(m$1({}, i), h.getChildContext())), x && !p && null != h.getSnapshotBeforeUpdate && (d = h.getSnapshotBeforeUpdate(v, y)), A = null != a && a.type === S && null == a.key ? E$1(a.props.children) : a, f = L(n, g$1(A) ? A : [A], u, t, i, r, o, e, f, c, s), h.base = u.__e, u.__u &= -161, h.__h.length && e.push(h), _ && (h.__E = h.__ = null);
  } catch (n) {
...
function E$1(n) {
  return "object" != typeof n || null == n || n.__b > 0 ? n : g$1(n) ? n.map(E$1) : m$1({}, n);
}
function G$1(u, t, i, r, o, e, f, c, s) {
  ...
  if (null == x) m === k || c && u.data == k || (u.data = k);else {
    ...
    for (a in m) y = m[a], "dangerouslySetInnerHTML" == a ? p = y : "children" == a || a in k || "value" == a && "defaultValue" in k || "checked" == a && "defaultChecked" in k || N$1(u, a, null, y, o);
    for (a in k) y = k[a], "children" == a ? v = y : "dangerouslySetInnerHTML" == a ? h = y : "value" == a ? w = y : "checked" == a ? _ = y : c && "function" != typeof y || m[a] === y || N$1(u, a, y, m[a], o);
    if (h) c || p && (h.__html == p.__html || h.__html == u.innerHTML) || (u.innerHTML = h.__html), t.__k = [];else if (p && (u.innerHTML = ""), L("template" == t.type ? u.content : u, g$1(v) ? v : [v], t, i, r, "foreignObject" == x ? "http://www.w3.org/1999/xhtml" : o, e, f, e ? e[0] : i.__k && $(i, 0), c, s), null != e) for (a = e.length; a--;) b(e[a]);
    c || (a = "value", "progress" == x && null == w ? u.removeAttribute("value") : null != w && (w !== u[a] || "progress" == x && !w || "option" == x && w != m[a]) && N$1(u, a, w, m[a], o), a = "checked", null != _ && _ != u[a] && N$1(u, a, _, m[a], o));
  }
  return u;
}
function J$1(n, u, t) {
...
l$1.unmount = function (n) {
  ...
  var c = function () {
    if (! --r.__u) {
      ...
      for (r.setState({
        __a: r.__b = null
      }); t = r.o.pop();) t.__P = l, t.forceUpdate();
    }
  };
...
function useEnsureStability(parentHookName, ...values) {
  const helperToEnsureStability = A([]);
  const shownError = A([]);
  ...
  const tryEnsureValue = q$1(() => {
    if (valueRef.current === Unset$2 && getInitialValue != undefined) {
      try {
        ...
        if (initialization !== 'off') cleanupCallbackRef.current = onChange?.(initialValue, undefined, undefined) ?? undefined;
      } catch (ex) {
...
const thisIsPreactSoWeNeedAPolyfill = I === _;
 ...
 * @param inputs
 */
const useBeforeLayoutEffect = thisIsPreactSoWeNeedAPolyfill ? useBeforeLayoutEffectPreact : I;
...
function useStableMergedCallback(...fns) {
  return useStableCallback((...args) => {
    ...
    for (let i = 0; i < fns.length; ++i) {
      let ret = fns[i]?.(...args);
      if (ret) {
        if (typeof ret == 'function') allFuncsReturned.add(ret);else if ("then" in ret) allPromisesReturned.add(ret);
      }
    }
    if (allPromisesReturned.size > 0) return async (...args) => {
      await Promise.all([...[...allFuncsReturned].map(f => f(...args)), ...allPromisesReturned]);
    };else if (allFuncsReturned.size > 0) return (...args) => {
      allFuncsReturned.forEach(f => f(...args));
    };else return;
  });
}
...
function useMonitoring(originalHook) {
  const impl = globalThis._monitor_call_duration ? useMonitoringImpl : dontUseMonitoringImpl;
...
function useMonitoringImpl(originalHook) {
  ...
  if (globalThis._monitor_call_duration) {
...
function monitorCallCount(hook) {
  ...
  globalThis._hookCallCount ??= {
    callCounts: {}
  };
  globalThis._hookCallCount.callCounts[name] ??= {
    moment: 0,
    total: 0
  };
  ...
  if (timeoutHandle == null) {
    timeoutHandle = requestIdleCallback(() => {
      ...
      const o = Object.entries(globalThis._hookCallCount.callCounts).map(([hook, counts]) => {
        return {
          Hook: hook || "?",
          Now: counts?.moment || 0,
      ...
      Object.entries(globalThis._hookCallCount.callCounts).forEach(([, counts]) => {
        counts.moment = 0;
      });
      timeoutHandle = null;
    });
...
function generateStack() {
  if (globalThis._generate_setState_stacks) {
    try {
      throw new Error();
    } catch (e) {
      return e.stack;
 ...
 */
function focus(e) {
  if (globalThis.LOG_FOCUS_CHANGES === true) {
...
function useTagProps(props, tag) {
  if (globalThis._generate_useTagProps_tags) {
    const [id] = d(() => ++idIndex);
      ...
      refElementParameters: {
        onElementChange: useStableCallback(element => {
          ...
          if (element) {
            ...
            if (e.current) io?.unobserve(e.current);
          }
        })
      }
    };
...
function useMultiSelectionChild({
  ...
  return useMonitoring(function useMultiSelectionChild() {
    ...
    const changeMultiSelected = useStableCallback((e, selected) => {
      ...
      if (selected) console.assert(!multiSelectionDisabled);else console.assert(multiSelectIsEnabled);
...
function debounce({
  debounceDuration: durationOrGetter,
  handlerIn: handler
}) {
  let timeoutHandle = null;
  let queuedArgs = null;
  ...
  function debounced(...args) {
    ...
    if (debounceTimeout == null) handler?.(...queuedArgs);else {
      if (timeoutHandle != null) cancel();
...
function throttle({
  handlerIn: handler,
  throttleDuration: durationOrGetter
}) {
  let timeoutHandle = null;
...
const UntabbableContext = X$1(false);
const ListNavigationSingleSelectionChildContext = X$1(null);
...
const DemoUseRovingTabIndex = N(function DemoUseRovingTabIndex() {
  ...
  return u("div", {
    ...
    children: [u("h2", {
      ...
      children: [u("li", {
        children: ["Turns a group of widgets into one singular composite widget with only ", u("strong", {
          children: "a single tab stop"
        }), " shared between them (a \"roving\" tab stop, because it wanders back and forth)."]
      }), u("li", {
        children: ["Navigation within this composite widget is done via:", u("ul", {
          children: [u("li", {
        ...
        children: "Staggering can be enabled on the list, which mounts children one at a time instead of all at once. With some precise CSS applied this can drastically improve the performance of mounting long lists on slower devices."
      }), u("li", {
        children: "The parent controls the selected index, only re-rendering affected children when it changes."
      }), u("li", {
        children: "Changing which child is focused or selected only re-renders a maximum of 2 children each time."
      }), u("li", {
        children: ["Lists can be nested, and there is no strict requirement on DOM structure (except for sorting/rearranging children, if you use that).", u("ul", {
          children: u("li", {
            children: ["If you don't need sorting/rearranging this DOM requirement is ", u("strong", {
              children: "optional"
            }), "; rearranging requires all children be in one contiguous array of VNodes so that their ", u("code", {
              children: "key"
      ...
      children: ["Imperatively set the tabbable index to: ", u("input", {
        type: "number",
        onInput: e => {
          e.preventDefault();
      ...
      children: ["Stagger delay: ", u("input", {
        type: "checkbox",
        checked: staggered,
        onInput: e => {
          e.preventDefault();
      ...
      children: ["Single-Selection mode:", u("label", {
        children: [u("input", {
      ...
      children: ["Multi-Selection mode:", u("label", {
        children: [u("input", {
    ...
    }), u(UntabbableContext.Provider, {
      value: untabbable,
      children: u(ListNavigationSingleSelectionChildContext.Provider, {
        value: context,
        children: u("ol", {
          start: 0,
          ...props,
...
const DemoUseRovingTabIndexChildren = N(function DemoUseRovingTabIndexChildren({
  count,
  max,
  min,
  staggered,
  ...
  return u(ListChildContext.Provider, {
    value: context,
    children: rearrangeableChildrenReturn.children
  });
});
const DemoUseRovingTabIndexChildOuter = N(function DemoUseRovingTabIndexChildOuter({
  index,
  word,
  indexOriginal,
  indexRepositioned
  ...
  const c = u(DemoUseRovingTabIndexChild, {
    word: word,
    index: index,
    childUseEffect: staggeredChildReturn.childUseEffect,
    indexOriginal: indexOriginal,
    indexRepositioned: indexRepositioned
  });
  return u("li", {
...
const DemoUseRovingTabIndexChild = N(function DemoUseRovingTabIndexChild({
  index,
  word,
  indexOriginal,
  indexRepositioned,
...
N(() => {
  ...
  return u("div", {
    className: "demo",
    children: [u("label", {
      children: ["Demo text: ", u("input", {
        value: hasCapture ? currentCapture : text,
        disabled: pending && disableConsecutive,
        onInput: syncHandler
      })]
    }), u("hr", {}), u("label", {
      children: ["# of milliseconds the async handler takes to run: ", u("input", {
        type: "number",
        value: timeout,
        onInput: e => setTimeout(e.currentTarget.valueAsNumber)
      })]
  ...
  return u("div", {
    ...
    children: [u("h2", {
      ...
      children: [u("li", {
        ...
        children: ["Regardless of if focus was lost because the ", u("code", {
          children: "body"
...
N(function DemoGlobalHandlerChildren({
  count,
  mode
}) {
  return u(S, {
    children: [...function* () {
      for (let i = 0; i < count; ++i) {
        yield u(DemoGlobalHandlerChild, {
          mode: mode,
          target: window
        }, i);
      }
...
const DemoGlobalHandlerChild = N(function DemoGlobalHandlerChild({
  mode,
  target
}) {
...
const Root = () => {
  return u("div", {
    ...
    children: [u(DemoUseRovingTabIndex, {}), u("hr", {})]
  });
};
requestAnimationFrame(() => {
  preactAddUseInsertionEffectHook(l$1);
  //preactAddUseInsertionEffectHook(options);
  createRoot(document.getElementById("root")).render(u(Root, {}));
});
