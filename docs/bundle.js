...
(() => {
  ...
  function y(l3, u3, i3) {
    var t3, r4, o4, f3 = {};
    for (o4 in u3)
      "key" == o4 ? t3 = u3[o4] : "ref" == o4 ? r4 = u3[o4] : f3[o4] = u3[o4];
    if (arguments.length > 2 && (f3.children = arguments.length > 3 ? n.call(arguments, 2) : i3), "function" == typeof l3 && null != l3.defaultProps)
      for (o4 in l3.defaultProps)
        void 0 === f3[o4] && (f3[o4] = l3.defaultProps[o4]);
    return p(l3, f3, t3, r4, null);
  }
  function p(n2, i3, t3, r4, o4) {
    var f3 = { type: n2, props: i3, key: t3, ref: r4, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: null == o4 ? ++u : o4 };
  ...
  function w() {
    var n2, l3, u3, i3, r4, o4, e3, c3;
    for (t.sort(f); n2 = t.shift(); )
      n2.__d && (l3 = t.length, i3 = void 0, r4 = void 0, e3 = (o4 = (u3 = n2).__v).__e, (c3 = u3.__P) && (i3 = [], (r4 = h({}, o4)).__v = o4.__v + 1, L(c3, o4, r4, u3.__n, void 0 !== c3.ownerSVGElement, null != o4.__h ? [e3] : null, i3, null == e3 ? b(o4) : e3, o4.__h), M(i3, o4), o4.__e != e3 && g(o4)), t.length > l3 && t.sort(f));
    w.__r = 0;
  }
  function x(n2, l3, u3, i3, t3, r4, o4, f3, e3, a3) {
    ...
    for (u3.__k = [], h3 = 0; h3 < l3.length; h3++)
      if (null != (d3 = u3.__k[h3] = null == (d3 = l3[h3]) || "boolean" == typeof d3 || "function" == typeof d3 ? null : "string" == typeof d3 || "number" == typeof d3 || "bigint" == typeof d3 ? p(null, d3, null, null, d3) : Array.isArray(d3) ? p(_, { children: d3 }, null, null, null) : d3.__b > 0 ? p(d3.type, d3.props, d3.key, d3.ref ? d3.ref : null, d3.__v) : d3)) {
        ...
        L(n2, d3, y3 = y3 || c, t3, r4, o4, f3, e3, a3), k4 = d3.__e, (v3 = d3.ref) && y3.ref != v3 && (m3 || (m3 = []), y3.ref && m3.push(y3.ref, null, d3), m3.push(v3, d3.__c || k4, d3)), null != k4 ? (null == g4 && (g4 = k4), "function" == typeof d3.type && d3.__k === y3.__k ? d3.__d = e3 = A(d3, e3, n2) : e3 = C(n2, d3, y3, w4, k4, e3), "function" == typeof u3.type && (u3.__d = e3)) : e3 && y3.__e == e3 && e3.parentNode != n2 && (e3 = b(y3));
      }
  ...
  function L(n2, u3, i3, t3, r4, o4, f3, e3, c3) {
    var s3, a3, v3, y3, p3, d3, b3, g4, m3, w4, A3, P3, C3, $3, H3, I3 = u3.type;
    ...
    try {
      n:
        if ("function" == typeof I3) {
          ...
          a3.state = a3.__s, null != a3.getChildContext && (t3 = h(h({}, t3), a3.getChildContext())), v3 || null == a3.getSnapshotBeforeUpdate || (d3 = a3.getSnapshotBeforeUpdate(y3, p3)), H3 = null != s3 && s3.type === _ && null == s3.key ? s3.props.children : s3, x(n2, Array.isArray(H3) ? H3 : [H3], u3, i3, t3, r4, o4, f3, e3, c3), a3.base = u3.__e, u3.__h = null, a3.__h.length && f3.push(a3), b3 && (a3.__E = a3.__ = null), a3.__e = false;
        } else
          null == o4 && u3.__v === i3.__v ? (u3.__k = i3.__k, u3.__e = i3.__e) : u3.__e = N(i3.__e, u3, i3, t3, r4, o4, f3, c3);
      (s3 = l.diffed) && s3(u3);
    } catch (n3) {
  ...
  function N(l3, u3, i3, t3, r4, o4, f3, e3) {
    ...
    if (null == l3) {
      ...
      l3 = r4 ? document.createElementNS("http://www.w3.org/2000/svg", d3) : document.createElement(d3, p3.is && p3), o4 = null, e3 = false;
    }
    if (null === d3)
      ...
      if (H(l3, p3, y3, r4, e3), h3)
        u3.__k = [];
      else if (_4 = u3.props.children, x(l3, Array.isArray(_4) ? _4 : [_4], u3, i3, t3, r4 && "foreignObject" !== d3, o4, f3, o4 ? o4[0] : i3.__k && b(i3, 0), e3), null != o4)
        for (_4 = o4.length; _4--; )
          null != o4[_4] && v(o4[_4]);
  ...
  function B(u3, i3, t3) {
    var r4, o4, f3;
    l.__ && l.__(u3, i3), o4 = (r4 = "function" == typeof t3) ? null : t3 && t3.__k || i3.__k, f3 = [], L(i3, u3 = (!r4 && t3 || i3).__k = y(_, null, [u3]), o4 || c, c, void 0 !== i3.ownerSVGElement, !r4 && t3 ? [t3] : o4 ? null : i3.firstChild ? n.call(i3.childNodes) : null, f3, !r4 && t3 ? t3 : o4 ? o4.__e : i3.firstChild, r4), M(f3, u3);
  }
  function E(l3, u3, i3) {
    var t3, r4, o4, f3 = h({}, l3.props);
    for (o4 in u3)
      "key" == o4 ? t3 = u3[o4] : "ref" == o4 ? r4 = u3[o4] : f3[o4] = u3[o4];
  ...
  n = s.slice, l = { __e: function(n2, l3, u3, i3) {
    for (var t3, r4, o4; l3 = l3.__; )
      if ((t3 = l3.__c) && !t3.__)
        try {
          if ((r4 = t3.constructor) && null != r4.getDerivedStateFromError && (t3.setState(r4.getDerivedStateFromError(n2)), o4 = t3.__d), null != t3.componentDidCatch && (t3.componentDidCatch(n2, i3 || {}), o4 = t3.__d), o4)
            return t3.__E = t3;
        } catch (l4) {
          n2 = l4;
        }
  ...
  l.unmount = function(n2) {
    ...
    var u3 = F3(r4.__v), o4 = false, i3 = function() {
  ...
  function getBuildModeUnmemoized() {
    ...
    try {
      ...
      try {
        (_a2 = globalThis["process"]) != null ? _a2 : globalThis["process"] = {};
        (_c = (_b = globalThis["process"])["env"]) != null ? _c : _b["env"] = {};
        (_e = (_d = globalThis["process"]["env"])["NODE_ENV"]) != null ? _e : _d["NODE_ENV"] = "production";
      } finally {
        return "production";
      }
    }
  ...
  function getBuildMode() {
    return cached != null ? cached : cached = getBuildModeUnmemoized();
  }
  ...
  var _a;
  (_a = window.requestIdleCallback) != null ? _a : window.requestIdleCallback = (callback) => {
    return setTimeout(() => {
  ...
  function callCountU(hook) {
    ...
    (_a2 = window._hookCallCount) != null ? _a2 : window._hookCallCount = { callCounts: {} };
    (_c = (_b = window._hookCallCount.callCounts)[name]) != null ? _c : _b[name] = { moment: 0, total: 0 };
    ...
    if (timeoutHandle == null) {
      timeoutHandle = requestIdleCallback(() => {
        const o4 = Object.entries(window._hookCallCount.callCounts).map(([hook2, counts]) => {
          return { Hook: hook2 || "?", Now: (counts == null ? void 0 : counts.moment) || 0, Total: (counts == null ? void 0 : counts.total) || 0 };
        }).filter(({ Now }) => {
          return !!Now;
        ...
        console.table(o4, ["Hook", "Now", "Total"]);
  ...
  var monitorCallCount = getBuildMode() == "development" ? callCountU : noop_default;
  ...
  function debounceRendering(f3) {
    var _a2;
    ((_a2 = l.debounceRendering) != null ? _a2 : queueMicrotask)(f3);
  }
  function usePassiveState(onChange, getInitialValue, customDebounceRendering) {
    ...
    const tryEnsureValue = T2(() => {
      ...
      if (valueRef.current === Unset && getInitialValue != void 0) {
        try {
          ...
          cleanupCallbackRef.current = (_a2 = onChange == null ? void 0 : onChange(initialValue, void 0, void 0)) != null ? _a2 : void 0;
        } catch (ex) {
        }
      }
    }, [
    ...
    const setValue = T2((arg, reason) => {
      ...
      if (dependencyToCompareAgainst.current === Unset && nextValue !== valueRef.current) {
        ...
        (customDebounceRendering != null ? customDebounceRendering : debounceRendering)(() => {
          var _a2;
          ...
          if (dependencyToCompareAgainst.current != valueRef.current) {
            ...
            try {
              onShouldCleanUp();
              cleanupCallbackRef.current = (_a2 = onChange == null ? void 0 : onChange(nextDep, prevDep === Unset ? void 0 : prevDep, nextReason)) != null ? _a2 : void 0;
  ...
  function useMergedClasses(lhsClass, lhsClassName, rhsClass, rhsClassName) {
    ...
    if (lhsClass || rhsClass || lhsClassName || rhsClassName) {
      ...
      const allClasses = /* @__PURE__ */ new Set([...Array.from(lhsClasses), ...Array.from(rhsClasses)]);
  ...
  // ../dist/preact-extensions/use-before-layout-effect.js
  ...
  var newCommit = (vnode, ...args) => {
    ...
    for (const [id, effectInfo] of toRun) {
      ...
      if (argsChanged(oldInputs, effectInfo.inputs)) {
        (_a2 = effectInfo.cleanup) == null ? void 0 : _a2.call(effectInfo);
        effectInfo.cleanup = effectInfo.effect();
        effectInfo.prevInputs = effectInfo.inputs;
      }
    }
    toRun.clear();
    originalCommit == null ? void 0 : originalCommit(vnode, ...args);
  };
  ...
  function useBeforeLayoutEffect(effect, inputs) {
    ...
    const ref = _2(null);
    (_a2 = ref.current) != null ? _a2 : ref.current = nextId();
  ...
  function argsChanged(oldArgs, newArgs) {
    return !!(!oldArgs || oldArgs.length !== (newArgs == null ? void 0 : newArgs.length) || (newArgs == null ? void 0 : newArgs.some((arg, index) => arg !== oldArgs[index])));
  }
  ...
  function useStableObject(t3) {
    const e3 = Object.entries(t3);
    useEnsureStability("useStableObject", e3.length, ...e3.map(([_k, v3]) => v3));
    return _2(t3).current;
  }
  ...
  function isStableGetter(obj) {
    var _a2;
    return (_a2 = map.get(obj)) != null ? _a2 : false;
  }
  ...
  function useStableCallback(fn, noDeps) {
    ...
    useEnsureStability("useStableCallback", noDeps == null, noDeps == null ? void 0 : noDeps.length, isStableGetter(fn));
  ...
  function mergeUnknown(key, lhsValue, rhsValue) {
    if (typeof lhsValue === "function" || typeof rhsValue === "function") {
      ...
      if (lhsValue == null)
        ...
        log == null ? void 0 : log(`The prop "${key}" cannot simultaneously be the values ${lhsValue} and ${rhsValue}. One must be chosen outside of useMergedProps.`);
        return rhsValue;
      }
    }
  }
  ...
  // ../dist/util/assert.js
  function assertEmptyObject(_a2) {
  }
  ...
  function useLinearNavigation({ rovingTabIndexReturn, linearNavigationParameters }) {
    ...
    const navigateAbsolute = T2((requestedIndexMangled, searchDirection, e3, fromUserInteraction, mode) => {
      ...
      const original = (_a2 = getTabbableIndex()) != null ? _a2 : 0;
      ...
      if (status == "past-end") {
        ...
        setTabbableIndex(valueUnmangled, e3, fromUserInteraction);
        return "stop";
      }
    }, []);
    const navigateToFirst = useStableCallback((e3, fromUserInteraction) => {
      return navigateAbsolute(0, -1, e3, fromUserInteraction, "single");
    });
  ...
  function tryNavigateToIndex({ isValid, highestChildIndex, searchDirection, indexDemangler, indexMangler, targetUnmangled }) {
    if (searchDirection === -1) {
      let bestUpResult = void 0;
      bestUpResult = tryNavigateUp({ isValid, indexDemangler, indexMangler, targetUnmangled });
      bestUpResult != null ? bestUpResult : bestUpResult = tryNavigateDown({ isValid, indexDemangler, indexMangler, targetUnmangled, highestChildIndex });
      ...
      bestDownResult != null ? bestDownResult : bestDownResult = tryNavigateUp({ isValid, indexDemangler, indexMangler, targetUnmangled });
    ...
    const remoteULEChildChanged = T2((index) => {
      if (remoteULEChildChangedCausers.current.size == 0) {
        if (onAfterChildLayoutEffect != null) {
          debounceRendering(() => {
            onAfterChildLayoutEffect == null ? void 0 : onAfterChildLayoutEffect(remoteULEChildChangedCausers.current);
    ...
    const remoteULEChildMounted = T2((index, mounted) => {
      if (!hasRemoteULEChildMounted.current) {
        ...
        if (onChildrenCountChange || onChildrenMountChange) {
          debounceRendering(() => {
            onChildrenMountChange == null ? void 0 : onChildrenMountChange(hasRemoteULEChildMounted.current.mounts, hasRemoteULEChildMounted.current.unmounts);
            onChildrenCountChange == null ? void 0 : onChildrenCountChange(getChildren().getHighestIndex() + 1);
  ...
  function useManagedChild({ context, info }) {
    ...
    const { managedChildContext: { getChildren, managedChildrenArray, remoteULEChildMounted, remoteULEChildChanged } } = context != null ? context : { managedChildContext: {} };
    ...
    y2(() => {
      remoteULEChildMounted == null ? void 0 : remoteULEChildMounted(index, true);
      return () => remoteULEChildMounted == null ? void 0 : remoteULEChildMounted(index, false);
    }, [index]);
    return {
  ...
  function useChildrenFlag({ getChildren, initialIndex, closestFit, onIndexChange, getAt, setAt, isValid }) {
    ...
    const reevaluateClosestFit = useStableCallback(() => {
      ...
      if (requestedIndex != null && closestFit && (requestedIndex != currentIndex || currentChild == null || !isValid(currentChild))) {
        ...
        setCurrentIndex(closestFitIndex, void 0);
        if (currentChild)
    ...
    y2(() => {
      changeIndex(initialIndex != null ? initialIndex : null, void 0);
    }, []);
  ...
  function useRovingTabIndex({ managedChildrenReturn: { getChildren }, rovingTabIndexParameters: { untabbable, initiallyTabbedIndex, onTabbableIndexChange }, ...void1 }) {
    ...
    const setTabbableIndex = useStableCallback((updater, reason, fromUserInteraction) => {
      ...
      return changeTabbableIndex(function returnModifiedTabbableIndex(prevIndex) {
        let nextIndex = typeof updater === "function" ? updater(prevIndex != null ? prevIndex : null) : updater;
        ...
        if (prevIndex != nextIndex) {
          ...
          console.assert(!(nextChild == null ? void 0 : nextChild.hidden));
        ...
        if (nextIndex != null)
          setLastNonNullIndex(nextIndex);
        return nextIndex != null ? nextIndex : 0;
      }, reason);
    }, []);
    const [getLastNonNullIndex, setLastNonNullIndex] = usePassiveState(null, T2(() => initiallyTabbedIndex != null ? initiallyTabbedIndex : 0, []));
    p2(() => {
      if (untabbable)
    ...
    const getTabbableAt = T2((m3) => {
      return m3.getLocallyTabbable();
    }, []);
    const setTabbableAt = T2((m3, t3) => {
      m3.setLocallyTabbable(t3);
    }, []);
    const isTabbableValid = T2((m3) => {
      return !m3.hidden;
    }, []);
    const { changeIndex: changeTabbableIndex, getCurrentIndex: getTabbableIndex, reevaluateClosestFit } = useChildrenFlag({
      initialIndex: initiallyTabbedIndex != null ? initiallyTabbedIndex : untabbable ? null : 0,
    ...
    const focusSelf = T2((reason) => {
      var _a2, _b, _c;
      const children = getChildren();
      const index = getTabbableIndex();
      if (index != null) {
        const element = (_a2 = children.getAt(index)) == null ? void 0 : _a2.getElement();
        (_c = (_b = children.getAt(index)) == null ? void 0 : _b.focusSelf) == null ? void 0 : _c.call(_b, element);
      } else
    ...
    const rovingTabIndexContext = useStableObject({
      ...
      getInitiallyTabbedIndex: T2(() => {
        return initiallyTabbedIndex != null ? initiallyTabbedIndex : untabbable ? null : 0;
      }, []),
  ...
  function useRovingTabIndexChild({ info: { index, hidden, ...void2 }, context: { rovingTabIndexContext: { reevaluateClosestFit, setTabbableIndex, getInitiallyTabbedIndex } }, ...void3 }) {
  ...
  function useTypeaheadNavigation({ typeaheadNavigationParameters: { collator, typeaheadTimeout, noTypeahead, isValid, ...void3 }, rovingTabIndexReturn: { getTabbableIndex: getIndex, setTabbableIndex: setIndex, ...void1 }, ...void2 }) {
    ...
    const [getCurrentTypeahead, setCurrentTypeahead] = usePassiveState(useStableCallback((currentTypeahead, prev, reason) => {
      ...
      }, typeaheadTimeout != null ? typeaheadTimeout : 1e3);
    ...
    y2(() => {
      if (nextTypeaheadChar !== null) {
        setCurrentTypeahead((typeahead) => (typeahead != null ? typeahead : "") + nextTypeaheadChar, void 0);
    ...
    const comparatorShared = useStableCallback((safeLhs, safeRhs) => {
      ...
      if (collator)
        ...
        compare = safeLhs.toLowerCase().localeCompare((_a2 = safeRhs.toLowerCase()) != null ? _a2 : "");
      return compare;
    });
    ...
    const propsStable = _2({
      onKeyDown: useStableCallback((e3) => {
        ...
        if (isCharacterKey) {
          if (key == " " && ((_a2 = getCurrentTypeahead()) != null ? _a2 : "").trim().length == 0) {
          } else {
            e3.preventDefault();
            e3.stopPropagation();
            if (!imeActive)
      ...
      if (currentTypeahead && sortedTypeaheadInfo.current.length) {
        ...
        if (sortedTypeaheadIndex < 0) {
          ...
          const updateBestFit = (u3) => {
            ...
            if ((lowestUnsortedIndexNext == null || u3 < lowestUnsortedIndexNext) && u3 > ((_a2 = getIndex()) != null ? _a2 : -Infinity)) {
  ...
  function useTypeaheadNavigationChild({ info: { index, ...void1 }, textContentParameters: { getText, hidden, ...void5 }, context: { typeaheadNavigationContext: { sortedTypeaheadInfo, insertingComparator, excludeSpace, ...void2 } }, refElementReturn: { getElement, ...void3 }, ...void4 }) {
  ...
  function useListNavigation({ linearNavigationParameters, typeaheadNavigationParameters, rovingTabIndexParameters, managedChildrenReturn, ...void1 }) {
  ...
  function useGridNavigation({ gridNavigationParameters: { onTabbableColumnChange, ...void3 }, linearNavigationParameters, rovingTabIndexParameters: { onTabbableIndexChange, ...rovingTabIndexParameters }, managedChildrenReturn, typeaheadNavigationParameters, ...void2 }) {
    ...
    const [getCurrentTabbableColumn, setCurrentTabbableColumn] = usePassiveState(onTabbableColumnChange, useStableCallback(() => {
      return initiallyTabbedIndex != null ? initiallyTabbedIndex : 0;
    }));
    const onTabbableIndexChangeOverride = useStableCallback((nextRow, previousRow, reason) => {
      var _a2, _b;
      const children = getChildren();
      onTabbableIndexChange == null ? void 0 : onTabbableIndexChange(nextRow, previousRow, reason);
      const nextColumn = getCurrentTabbableColumn();
      if (previousRow != null)
        (_a2 = children.getAt(previousRow)) == null ? void 0 : _a2.setTabbableColumnIndex(nextColumn, reason, false);
      if (nextRow != null)
        (_b = children.getAt(nextRow)) == null ? void 0 : _b.setTabbableColumnIndex(nextColumn, reason, false);
    });
  ...
  function useGridNavigationRow({ context: { rovingTabIndexContext: contextRTI, typeaheadNavigationContext: contextTN, gridNavigationRowContext: { setTabbableRow, getCurrentTabbableColumn, setCurrentTabbableColumn } }, linearNavigationParameters, rovingTabIndexParameters: { ...rovingTabIndexParameters }, info: managedChildParameters, managedChildrenReturn, refElementReturn, textContentParameters, typeaheadNavigationParameters, ...void1 }) {
    ...
    const focusSelf = useStableCallback((e3) => {
      ...
      if (child) {
        ...
        (_b = e3 == null ? void 0 : e3.focus) == null ? void 0 : _b.call(e3);
      }
    }, []);
  ...
  function useGridNavigationCell({ context: { gridNavigationCellContext: { getRowIndex, setTabbableRow, getCurrentTabbableColumn: _getCurrentColumn, setCurrentTabbableColumn, setTabbableCell }, rovingTabIndexContext, typeaheadNavigationContext }, info, refElementReturn, textContentParameters, gridNavigationCellParameters: { colSpan }, ...void1 }) {
    ...
    return {
      ...
      hasCurrentFocusParameters: {
        onCurrentFocusedInnerChanged: useStableCallback((focused, prev, e3) => {
          ocfic1 == null ? void 0 : ocfic1(focused, prev, e3);
          if (focused) {
            setTabbableRow(getRowIndex(), e3, false);
            setCurrentTabbableColumn(index, e3);
  ...
  // ../dist/component-detail/keyboard-navigation/use-single-selection.js
  function useSingleSelection({ managedChildrenReturn: { getChildren }, rovingTabIndexReturn: { setTabbableIndex }, singleSelectionParameters: { onSelectedIndexChange: onSelectedIndexChange_U, initiallySelectedIndex, ariaPropName, selectionMode } }) {
    monitorCallCount(useSingleSelection);
    useEnsureStability("useSingleSelection", ariaPropName, selectionMode);
    const onSelectedIndexChange = useStableCallback(onSelectedIndexChange_U != null ? onSelectedIndexChange_U : noop_default);
    const getSelectedAt = T2((m3) => {
      return m3.getSelected();
    }, []);
    const setSelectedAt = T2((m3, t3, newSelectedIndex, prevSelectedIndex) => {
      ...
      m3.setLocalSelected(t3, direction);
    }, []);
  ...
  function useSingleSelectionChild(args) {
    ...
    const onCurrentFocusedInnerChanged = useStableCallback((focused, _prev, e3) => {
      if (selectionMode == "focus" && focused) {
        onSelectedIndexChange == null ? void 0 : onSelectedIndexChange(index, e3);
      }
    });
    const propParts = (_a2 = ariaPropName == null ? void 0 : ariaPropName.split("-")) != null ? _a2 : [];
    return {
      info: {
        setLocalSelected: useStableCallback((selected, direction2) => {
      ...
      singleSelectionChildReturn: {
        ...
        setThisOneSelected: useStableCallback((event) => {
          ...
          if (selectionMode == "disabled")
            return;
          if (!disabled)
            onSelectedIndexChange == null ? void 0 : onSelectedIndexChange(index, event);
        }),
  ...
  function useSingleSelectionDeclarative({ singleSelectionReturn: { changeSelectedIndex }, singleSelectionDeclarativeParameters: { selectedIndex, setSelectedIndex } }) {
    p2(() => {
  ...
  // ../dist/component-detail/keyboard-navigation/use-grid-navigation-single-selection.js
  function useGridNavigationSingleSelection({ gridNavigationParameters, linearNavigationParameters, rovingTabIndexParameters, managedChildrenReturn, typeaheadNavigationParameters, singleSelectionParameters, ...void2 }) {
  ...
  function useGridNavigationSingleSelectionRow({ info: mcp1, linearNavigationParameters, managedChildrenReturn, refElementReturn, rovingTabIndexParameters, textContentParameters, typeaheadNavigationParameters, context: { gridNavigationRowContext, rovingTabIndexContext, singleSelectionContext, typeaheadNavigationContext }, ...void1 }) {
    ...
    return {
      ...
      managedChildrenParameters,
      pressParameters: { excludeSpace },
      hasCurrentFocusParameters: { onCurrentFocusedInnerChanged: useStableCallback((hasFocus, hadFocus) => {
        ocfic1 == null ? void 0 : ocfic1(hasFocus, hadFocus);
        ocfic2 == null ? void 0 : ocfic2(hasFocus, hadFocus);
      }) },
  ...
  function useGridNavigationSingleSelectionCell(p3) {
  ...
  // ../dist/component-detail/keyboard-navigation/use-sortable-children.js
  function useRearrangeableChildren({ rearrangeableChildrenParameters: { getIndex, onRearranged }, managedChildrenReturn: { getChildren } }) {
    ...
    const indexMangler = T2((n2) => {
      var _a2;
      return (_a2 = mangleMap.current.get(n2)) != null ? _a2 : n2;
    }, []);
    const indexDemangler = T2((n2) => {
      var _a2;
      return (_a2 = demangleMap.current.get(n2)) != null ? _a2 : n2;
    }, []);
    ...
    const rearrange = T2((originalRows, sortedRows) => {
      ...
      (_a2 = onRearrangedGetter()) == null ? void 0 : _a2();
      (_b = getForceUpdate()) == null ? void 0 : _b();
    }, []);
    const useRearrangedChildren = T2(function useRearrangedChildren2(children) {
      ...
      return children.slice().map((child) => ({ child, mangledIndex: indexMangler(getIndex(child)), demangledIndex: getIndex(child) })).sort((lhs, rhs) => {
        ...
        return y(child.type, { ...child.props, key: demangledIndex, "data-mangled-index": mangledIndex, "data-unmangled-index": demangledIndex });
      });
    }, []);
  ...
  function useSortableChildren({ rearrangeableChildrenParameters, sortableChildrenParameters: { compare: userCompare }, managedChildrenReturn: { getChildren } }) {
    ...
    const getCompare = useStableGetter(userCompare != null ? userCompare : defaultCompare);
  ...
  function defaultCompare(lhs, rhs) {
    return compare1(lhs == null ? void 0 : lhs.getSortValue(), rhs == null ? void 0 : rhs.getSortValue());
  ...
  // ../dist/component-detail/keyboard-navigation/use-grid-navigation-single-selection-sortable.js
  ...
  // ../dist/component-detail/keyboard-navigation/use-list-navigation-single-selection.js
  function useListNavigationSingleSelection({ linearNavigationParameters, rovingTabIndexParameters, typeaheadNavigationParameters, singleSelectionParameters, managedChildrenReturn, ...void3 }) {
    ...
    return {
      hasCurrentFocusParameters: {
        onCurrentFocusedInnerChanged: useStableCallback((focused, previouslyFocused, e3) => {
          ocfic1 == null ? void 0 : ocfic1(focused, previouslyFocused, e3);
          ocfic2 == null ? void 0 : ocfic2(focused, previouslyFocused, e3);
        })
      },
      pressParameters,
      info: { ...infoSS, ...infoLN },
  ...
  // ../dist/component-detail/keyboard-navigation/use-list-navigation-single-selection-sortable.js
  function useListNavigationSingleSelectionSortable({ linearNavigationParameters, rovingTabIndexParameters, typeaheadNavigationParameters, singleSelectionParameters, managedChildrenReturn, rearrangeableChildrenParameters, sortableChildrenParameters, ...void3 }) {
  ...
  function useGlobalHandlerGrouped(target, type, handler, options) {
    let stableHandler = useStableCallback(handler != null ? handler : () => {
    });
    if (handler == null)
      stableHandler = null;
    p2(() => {
  ...
  function useRefElement(args) {
    ...
    const handler = T2((e3, prevValue) => {
      const cleanup = onElementChange == null ? void 0 : onElementChange(e3, prevValue);
      if (prevValue)
        onUnmount == null ? void 0 : onUnmount(prevValue);
      if (e3)
        onMount == null ? void 0 : onMount(e3);
      return cleanup;
    }, []);
    const [getElement, setElement] = usePassiveState(handler, returnNull, runImmediately);
    const propsStable = _2({ ref: setElement });
    return {
      propsStable: propsStable.current,
      refElementReturn: {
        getElement
  ...
  function useActiveElement({ activeElementParameters: { onActiveElementChange, onLastActiveElementChange, onWindowFocusedChange, getDocument: getDocument3, getWindow: getWindow2 } }) {
    monitorCallCount(useActiveElement);
    useEnsureStability("useActiveElement", onActiveElementChange, onLastActiveElementChange, onWindowFocusedChange, getDocument3, getWindow2);
    p2(() => {
      var _a2, _b, _c, _d, _e, _f;
      const document2 = getDocument3();
      const window2 = (_a2 = getWindow2 == null ? void 0 : getWindow2(document2)) != null ? _a2 : document2 == null ? void 0 : document2.defaultView;
      if (((_c = (_b = activeElementUpdaters.get(window2)) == null ? void 0 : _b.size) != null ? _c : 0) === 0) {
        document2 == null ? void 0 : document2.addEventListener("focusin", focusin, { passive: true });
        document2 == null ? void 0 : document2.addEventListener("focusout", focusout, { passive: true });
        window2 == null ? void 0 : window2.addEventListener("focus", windowFocus, { passive: true });
        window2 == null ? void 0 : window2.addEventListener("blur", windowBlur, { passive: true });
      }
      const localActiveElementUpdaters = (_d = activeElementUpdaters.get(window2)) != null ? _d : /* @__PURE__ */ new Set();
      const localLastActiveElementUpdaters = (_e = lastActiveElementUpdaters.get(window2)) != null ? _e : /* @__PURE__ */ new Set();
      const localWindowFocusedUpdaters = (_f = windowFocusedUpdaters.get(window2)) != null ? _f : /* @__PURE__ */ new Set();
      ...
      activeElementUpdaters.set(window2, localActiveElementUpdaters);
      lastActiveElementUpdaters.set(window2, localLastActiveElementUpdaters);
      windowFocusedUpdaters.set(window2, localWindowFocusedUpdaters);
      return () => {
        activeElementUpdaters.get(window2).delete(laeu);
        lastActiveElementUpdaters.get(window2).delete(laeu);
        windowFocusedUpdaters.get(window2).delete(lwfu);
        if (activeElementUpdaters.size === 0) {
          document2 == null ? void 0 : document2.removeEventListener("focusin", focusin);
          document2 == null ? void 0 : document2.removeEventListener("focusout", focusout);
          window2 == null ? void 0 : window2.removeEventListener("focus", windowFocus);
          window2 == null ? void 0 : window2.removeEventListener("blur", windowBlur);
        }
      };
    }, []);
  ...
  function useEscapeDismiss({ escapeDismissParameters: { onClose, open, getWindow: unstableGetWindow, parentDepth, ...void1 }, refElementPopupReturn: { getElement, ...void2 } }) {
    ...
    const getWindow2 = useStableCallback(unstableGetWindow);
    const getDepth = useStableGetter(parentDepth + 1);
    p2(() => {
      var _a2;
      const window2 = getWindow2();
      (_a2 = window2[MagicWindowKey]) != null ? _a2 : window2[MagicWindowKey] = { microtaskQueued: false, elementQueue: /* @__PURE__ */ new Map() };
        ...
        if (e3.key == "Escape") {
          ...
          if (!info.microtaskQueued) {
            ...
            setTimeout(() => {
              ...
              deepestOnClose == null ? void 0 : deepestOnClose();
            }, 0);
          }
        }
      }
  ...
  function useLostFocusDismiss({ refElementPopupReturn: { getElement: getPopupElement, ...void3 }, refElementSourceReturn, lostFocusDismiss: { open, onClose }, ...void1 }) {
    ...
    const { getElement: getSourceElement, ...void2 } = refElementSourceReturn != null ? refElementSourceReturn : {};
    assertEmptyObject(void1);
    assertEmptyObject(void2);
    assertEmptyObject(void3);
    const stableOnClose = useStableCallback(onClose);
    const getOpen = useStableGetter(open);
    const onLastActiveElementChange = T2((newElement, _prevElement, _e) => {
      const open2 = getOpen();
      const sourceElement = getSourceElement == null ? void 0 : getSourceElement();
      const popupElement = getPopupElement();
      if (!((sourceElement == null ? void 0 : sourceElement.contains(newElement)) || (popupElement == null ? void 0 : popupElement.contains(newElement)))) {
        if (open2)
          stableOnClose();
      }
    }, [getSourceElement]);
  ...
  function useDismiss({ dismissParameters: { open: globalOpen, onClose: globalOnClose, closeOnBackdrop, closeOnEscape, closeOnLostFocus }, escapeDismissParameters: { getWindow: getWindow2, parentDepth } }) {
    ...
    const onCloseBackdrop = T2(() => {
      return globalOnClose == null ? void 0 : globalOnClose("backdrop");
    }, [globalOnClose]);
    const onCloseEscape = T2(() => {
      return globalOnClose == null ? void 0 : globalOnClose("escape");
    }, [globalOnClose]);
    const onCloseFocus = T2(() => {
      return globalOnClose == null ? void 0 : globalOnClose("lost-focus");
    }, [globalOnClose]);
    ...
    const _v2 = useEscapeDismiss({ escapeDismissParameters: { getWindow: getWindow2, onClose: onCloseEscape, open: closeOnEscape && globalOpen, parentDepth }, refElementPopupReturn });
    ...
    const getDocument3 = T2(() => {
      return getWindow2().document;
    }, [getWindow2]);
    const { activeElementReturn: { getActiveElement: _getActiveElement, getLastActiveElement: _getLastActiveElement, getWindowFocused: _getWindowFocused } } = useActiveElement({ activeElementParameters: { ...activeElementParameters, getWindow: getWindow2, getDocument: getDocument3 } });
    return {
  ...
  function getDocument(element) {
    var _a2, _b, _c;
    return (_c = (_b = (_a2 = element == null ? void 0 : element.ownerDocument) != null ? _a2 : document) != null ? _b : window.document) != null ? _c : globalThis.document;
  }
  ...
  function useBlockingElement(enabled, getTarget) {
    ...
    const getDocument3 = useStableCallback(() => {
      var _a2, _b;
      return (_b = (_a2 = getTarget()) == null ? void 0 : _a2.ownerDocument) != null ? _b : globalThis.document;
    });
    useActiveElement({
      activeElementParameters: {
        getDocument: getDocument3,
        onLastActiveElementChange: useStableCallback((e3) => {
          if (e3) {
            if (enabled)
              setLastActiveWhenOpen(e3);
            else
              setLastActiveWhenClosed(e3);
          }
        })
      }
    });
  ...
  function useFocusTrap({ focusTrapParameters: { onlyMoveFocus, trapActive, focusPopup: focusSelfUnstable, focusOpener: focusOpenerUnstable }, refElementReturn }) {
    ...
    p2(() => {
      if (trapActive) {
        ...
        if (false) {
          ...
          top != null ? top : top = refElementReturn.getElement();
          console.assert(!!top);
          if (top)
    ...
    return {
      props: { "aria-modal": trapActive ? "true" : void 0 },
      focusTrapReturn: {}
    };
  }
  ...
  function findFirstCondition(element, filter) {
    ...
    element != null ? element : element = document.body;
  ...
  function usePaginatedChildren({ managedChildrenReturn: { getChildren }, linearNavigationParameters: { indexDemangler }, paginatedChildrenParameters: { paginationMax, paginationMin } }) {
    ...
    const refreshPagination = T2((paginationMin2, paginationMax2) => {
      ...
      for (let i3 = 0; i3 <= childMax; ++i3) {
        const visible = i3 >= (paginationMin2 != null ? paginationMin2 : -Infinity) && i3 < (paginationMax2 != null ? paginationMax2 : Infinity);
        (_a2 = getChildren().getAt(indexDemangler(i3))) == null ? void 0 : _a2.setParentIsPaginated(parentIsPaginated);
        (_b = getChildren().getAt(indexDemangler(i3))) == null ? void 0 : _b.setPaginationVisible(visible);
        if (visible)
          (_c = getChildren().getAt(indexDemangler(i3))) == null ? void 0 : _c.setChildCountIfPaginated(getChildren().getHighestIndex() + 1);
      }
    }, [
      /* Must be empty */
    ]);
    ...
    const p3 = _2(parentIsPaginated);
    p3.current = parentIsPaginated;
    return {
      context: useStableObject({
        paginatedChildContext: useStableObject({
          getDefaultIsPaginated: T2(() => {
            return p3.current;
          }, []),
          ...
          getDefaultPaginationVisible: T2((i3) => {
            return p3.current ? i3 >= (paginationMin != null ? paginationMin : -Infinity) && i3 < (paginationMax != null ? paginationMax : Infinity) : true;
          }, [])
        })
      }),
      managedChildrenParameters: {
        onChildrenCountChange: useStableCallback((count) => {
          ...
          if (paginationMax != null || paginationMin != null) {
            setChildCount(count);
            const min = paginationMin != null ? paginationMin : 0;
            const max = paginationMax != null ? paginationMax : count;
            for (let i3 = min; i3 < max; ++i3) {
              (_a2 = getChildren().getAt(i3)) == null ? void 0 : _a2.setParentIsPaginated(parentIsPaginated);
              (_b = getChildren().getAt(i3)) == null ? void 0 : _b.setChildCountIfPaginated(count);
            }
          } else {
            setChildCount(null);
          }
  ...
  function usePaginatedChild({ info: { index }, context: { paginatedChildContext: { getDefaultPaginationVisible, getDefaultIsPaginated } } }) {
    ...
    return {
      props: !parentIsPaginated ? {} : { "aria-setsize": childCountIfPaginated != null ? childCountIfPaginated : void 0, "aria-posinset": index + 1 },
  ...
  function useStaggeredChildren({ managedChildrenReturn: { getChildren }, staggeredChildrenParameters: { staggered } }) {
    ...
    const resetEmergencyTimeout = T2(() => {
      ...
      timeoutHandle2.current = setTimeout(() => {
        ...
        if (target != null)
          setDisplayedStaggerIndex((c3) => Math.min(target, (c3 != null ? c3 : 0) + 1));
      }, 50);
    }, [
      /* Must be empty */
    ]);
    const [getTargetStaggerIndex, setTargetStaggerIndex] = usePassiveState(T2((newIndex, _prevIndex) => {
      if (timeoutHandle2.current == -1) {
        ...
        setDisplayedStaggerIndex((c3) => Math.min(newIndex != null ? newIndex : 0, (c3 != null ? c3 : 0) + 1));
      }
    }, [
      /* Must be empty */
    ]), returnNull);
    const [getDisplayedStaggerIndex, setDisplayedStaggerIndex] = usePassiveState(T2((newIndex, prevIndex) => {
      ...
      setCurrentlyStaggering(newIndex < ((_a2 = getTargetStaggerIndex()) != null ? _a2 : 0));
      for (let i3 = prevIndex != null ? prevIndex : 0; i3 < newIndex; ++i3) {
        (_b = getChildren().getAt(i3)) == null ? void 0 : _b.setStaggeredVisible(true);
      }
      resetEmergencyTimeout();
    }, [
      /* Must be empty */
    ...
    const childCallsThisToTellTheParentToMountTheNextOne = T2((index) => {
      setDisplayedStaggerIndex((s4) => {
        var _a2;
        return Math.min((_a2 = getTargetStaggerIndex()) != null ? _a2 : 0, 1 + Math.max(s4 != null ? s4 : 0, index + 1));
      });
    }, []);
    y2(() => {
    ...
    const childCallsThisToTellTheParentTheHighestIndex = T2((mountedIndex) => {
      setTargetStaggerIndex((i3) => Math.max(i3 != null ? i3 : 0, 1 + mountedIndex));
    }, []);
    const s3 = _2(parentIsStaggered);
    ...
    return {
      ...
      context: useStableObject({
        staggeredChildContext: useStableObject({
          ...
          getDefaultIsStaggered: T2(() => {
            return s3.current;
          }, []),
          getDefaultStaggeredVisible: T2((i3) => {
            if (s3.current) {
  ...
  function useStaggeredChild({ info: { index }, context: { staggeredChildContext: { childCallsThisToTellTheParentTheHighestIndex, getDefaultIsStaggered, getDefaultStaggeredVisible, childCallsThisToTellTheParentToMountTheNextOne } } }) {
  ...
  function useChildrenHaveFocusChild({ context: { childrenHaveFocusChildContext: { setFocusCount } } }) {
    ...
    return {
      hasCurrentFocusParameters: {
        onCurrentFocusedInnerChanged: useStableCallback((focused, prev, e3) => {
          if (focused) {
            setFocusCount((p3) => (p3 != null ? p3 : 0) + 1, e3);
  ...
  function useCompleteGridNavigation({ gridNavigationParameters, linearNavigationParameters, rovingTabIndexParameters, singleSelectionParameters, typeaheadNavigationParameters, sortableChildrenParameters, rearrangeableChildrenParameters, paginatedChildrenParameters, staggeredChildrenParameters }) {
    ...
    const mcr = useManagedChildren({ managedChildrenParameters: { onChildrenCountChange: useStableCallback((c3) => onChildrenCountChange(c3)), ...managedChildrenParameters } });
  ...
  function useCompleteGridNavigationRow({ info, context: contextIncomingForRowAsChildOfTable, textContentParameters, linearNavigationParameters, rovingTabIndexParameters, typeaheadNavigationParameters, sortableChildParameters }) {
    ...
    } = useStaggeredChild({ info, context: contextIncomingForRowAsChildOfTable });
    ...
    const r4 = useGridNavigationSingleSelectionRow({
      rovingTabIndexParameters: { initiallyTabbedIndex: 0, ...rovingTabIndexParameters },
      typeaheadNavigationParameters: { isValid, ...typeaheadNavigationParameters },
      linearNavigationParameters: { isValid, getHighestIndex: getHighestChildIndex, pageNavigationSize: 0, indexDemangler: identity_default, indexMangler: identity_default, ...linearNavigationParameters },
      managedChildrenReturn: { getChildren },
      refElementReturn,
  ...
  function useCompleteGridNavigationCell({ gridNavigationCellParameters, context: { gridNavigationCellContext, managedChildContext, rovingTabIndexContext, typeaheadNavigationContext }, textContentParameters, info }) {
  ...
  function useCompleteListNavigation({ linearNavigationParameters, rearrangeableChildrenParameters, sortableChildrenParameters, typeaheadNavigationParameters, rovingTabIndexParameters, singleSelectionParameters, paginatedChildrenParameters, staggeredChildrenParameters, ...completeListNavigationParameters }) {
    ...
    const { context: { managedChildContext }, managedChildrenReturn } = useManagedChildren({
      managedChildrenParameters: {
        onChildrenCountChange: useStableCallback((c3) => {
          onChildrenCountChange(c3);
        }),
  ...
  function useCompleteListNavigationChild({ info, textContentParameters, context: { childrenHaveFocusChildContext, managedChildContext, rovingTabIndexContext, paginatedChildContext, staggeredChildContext, singleSelectionContext, typeaheadNavigationContext }, sortableChildParameters, ...void1 }) {
    ...
    const onCurrentFocusedInnerChanged = useStableCallback((focused, prev, e3) => {
      ocfic1 == null ? void 0 : ocfic1(focused, prev, e3);
      ocfic2 == null ? void 0 : ocfic2(focused, prev, e3);
    });
  ...
  function useCompleteListNavigationDeclarative({ linearNavigationParameters, paginatedChildrenParameters, rearrangeableChildrenParameters, rovingTabIndexParameters, singleSelectionDeclarativeParameters, sortableChildrenParameters, staggeredChildrenParameters, typeaheadNavigationParameters, singleSelectionParameters }) {
    const ret = useCompleteListNavigation({
      ...
      singleSelectionParameters: {
        ...
        onSelectedIndexChange: useStableCallback((a3, e3) => onSelectedIndexChange == null ? void 0 : onSelectedIndexChange(a3, e3)),
        ...singleSelectionParameters
      },
      sortableChildrenParameters,
  ...
  function useTimeout({ timeout, callback, triggerIndex }) {
    ...
    const getElapsedTime = T2(() => {
      var _a2;
      return +/* @__PURE__ */ new Date() - +((_a2 = startTimeRef.current) != null ? _a2 : /* @__PURE__ */ new Date());
    }, []);
  ...
  function usePress(args) {
    ...
    const excludeEnter = useStableCallback(ee != null ? ee : returnFalse);
    const excludeSpace = useStableCallback(es != null ? es : returnFalse);
    const excludePointer = useStableCallback(ep != null ? ep : returnFalse);
    const onPressingChange = useStableCallback(opc != null ? opc : noop_default);
    ...
    const onTouchMove = T2((e3) => {
      ...
      for (const [x4, y3] of offsets) {
        const elementAtTouch = document.elementFromPoint(((_a2 = touch == null ? void 0 : touch.clientX) != null ? _a2 : 0) + x4, ((_b = touch == null ? void 0 : touch.clientY) != null ? _b : 0) + y3);
        hoveringAtAnyPoint || (hoveringAtAnyPoint = (_c = element == null ? void 0 : element.contains(elementAtTouch)) != null ? _c : false);
      }
    ...
    const onPointerMove = useStableCallback((e3) => {
      ...
      if (listeningForPress) {
        ...
        const hovering2 = element == elementAtPointer || (element == null ? void 0 : element.contains(elementAtPointer)) || false;
    ...
    useTimeout({
      ...
      timeout: longPressThreshold != null ? longPressThreshold : null,
    ...
    const onKeyDown = useStableCallback((e3) => {
      if (onPressSync) {
        ...
        if (e3.key == "Enter" && !excludeEnter() && (!e3.repeat || (allowRepeatPresses != null ? allowRepeatPresses : false))) {
          setIsPressing(true, e3);
          handlePress(e3);
      ...
      if (onPressSync) {
        ...
        if (e3.detail > 1) {
          ...
          if (
            ...
            e3.target == element && // Ignore click events that were fired on a radio that just became checked
            ...
            (element == null ? void 0 : element.tagName) == "input" && element.type == "radio" && element.checked
          ) {
            debugger;
  ...
  function asyncToSync({ asyncInput, onInvoke, onInvoked, onFinally: onFinallyAny, onReject, onResolve, onHasError, onHasResult, onError, onReturnValue, capture, onAsyncDebounce, onSyncDebounce, onPending, throttle, wait }) {
    ...
    const onFinally = () => {
      onFinallyAny == null ? void 0 : onFinallyAny();
      onPending == null ? void 0 : onPending(pending = false);
      let nothingElseToDo = !asyncDebouncing;
      onAsyncDebounce == null ? void 0 : onAsyncDebounce(asyncDebouncing = false);
      if (nothingElseToDo) {
      } else {
        console.assert(currentCapture !== Unset3);
        if (currentCapture != Unset3) {
          onSyncDebounce == null ? void 0 : onSyncDebounce(syncDebouncing = true);
          syncDebounced();
        }
      }
    };
    const sync = (...args) => {
      onPending == null ? void 0 : onPending(pending = true);
      console.assert(syncDebouncing == false);
      onHasError == null ? void 0 : onHasError(null);
      onHasResult == null ? void 0 : onHasResult(null);
      let promiseOrReturn;
      let hadSyncError = false;
      try {
        onInvoke == null ? void 0 : onInvoke();
        promiseOrReturn = asyncInput(...args);
        onHasError == null ? void 0 : onHasError(false);
      } catch (ex) {
        hadSyncError = true;
        onError == null ? void 0 : onError(ex);
        onInvoked == null ? void 0 : onInvoked("throw");
      }
      if (isPromise(promiseOrReturn)) {
        onInvoked == null ? void 0 : onInvoked("async");
        promiseOrReturn.then((r4) => {
          onResolve == null ? void 0 : onResolve();
          onHasResult == null ? void 0 : onHasResult(true);
          onReturnValue == null ? void 0 : onReturnValue(r4);
          return r4;
        }).catch((e3) => {
          onReject == null ? void 0 : onReject();
          onHasError == null ? void 0 : onHasError(true);
          onError == null ? void 0 : onError(e3);
          return e3;
        }).finally(onFinally);
      } else {
        onInvoked == null ? void 0 : onInvoked("sync");
        if (!hadSyncError) {
          onResolve == null ? void 0 : onResolve();
          onHasResult == null ? void 0 : onHasResult(true);
          onHasError == null ? void 0 : onHasError(false);
          ...
          onReject == null ? void 0 : onReject();
          onHasResult == null ? void 0 : onHasResult(false);
          onHasError == null ? void 0 : onHasError(true);
        }
        onReturnValue == null ? void 0 : onReturnValue(promiseOrReturn);
        onPending == null ? void 0 : onPending(pending = false);
        onFinally();
      }
    };
    ...
    const syncDebounced = debounce_default(() => {
      onSyncDebounce == null ? void 0 : onSyncDebounce(syncDebouncing = false);
      if (!pending) {
        console.assert(currentCapture != Unset3);
        sync(...currentCapture);
      } else {
        onAsyncDebounce == null ? void 0 : onAsyncDebounce(asyncDebouncing = true);
      }
    }, wait || void 0, lodashOptions);
    return {
      syncOutput: (...args) => {
        var _a2;
        currentCapture = (_a2 = capture == null ? void 0 : capture(...args)) != null ? _a2 : [];
        onSyncDebounce == null ? void 0 : onSyncDebounce(syncDebouncing = true);
        syncDebounced();
      },
      flushSyncDebounce: () => {
  ...
  function useAsync(asyncHandler2, options) {
    ...
    let { throttle, debounce: debounce2, capture: captureUnstable } = options != null ? options : {};
    const captureStable = useStableCallback(captureUnstable != null ? captureUnstable : identityCapture);
    const asyncHandlerStable = useStableCallback(asyncHandler2 != null ? asyncHandler2 : identity_default);
    const { flushSyncDebounce, syncOutput, cancelSyncDebounce } = F2(() => {
      return asyncToSync({
        ...
        throttle: options == null ? void 0 : options.throttle,
        wait: options == null ? void 0 : options.debounce
      });
    }, [throttle, debounce2]);
    p2(() => {
  ...
  function useDraggable({ effectAllowed, data, dragImage, dragImageXOffset, dragImageYOffset }) {
    ...
    const onDragStart = (e3) => {
      setDragging(true);
      if (e3.dataTransfer) {
        e3.dataTransfer.effectAllowed = effectAllowed != null ? effectAllowed : "all";
        if (dragImage)
          e3.dataTransfer.setDragImage(dragImage, dragImageXOffset != null ? dragImageXOffset : 0, dragImageYOffset != null ? dragImageYOffset : 0);
  ...
  var DroppableFileError = class extends Error {
    constructor(fileName, base) {
      var _a2;
      super((_a2 = base == null ? void 0 : base.message) != null ? _a2 : "An unspecified error occurred reading the file.");
      __publicField(this, "fileName");
      __publicField(this, "errorType");
      this.fileName = fileName;
      this.errorType = base == null ? void 0 : base.name;
    }
  };
  function useDroppable({ effect }) {
    ...
    const onDragEnter = useStableCallback((e3) => {
      ...
      e3.preventDefault();
      if (e3.dataTransfer) {
        e3.dataTransfer.dropEffect = effect != null ? effect : "move";
        const newMimeTypes = /* @__PURE__ */ new Set();
        const newFiles = new Array();
        for (const item of (_b = (_a2 = e3.dataTransfer) == null ? void 0 : _a2.items) != null ? _b : []) {
  ...
  function htmlToElement(parent, html) {
    ...
    templateElement != null ? templateElement : templateElement = document2.createElement("template");
  ...
  function useImperativeProps({ refElementReturn: { getElement } }) {
    ...
    const setClass = T2((cls, enabled) => {
      ...
      if (hasClass(cls) == !enabled) {
        (_a2 = getElement()) == null ? void 0 : _a2.classList[enabled ? "add" : "remove"](cls);
      ...
      if (element) {
        if (currentImperativeProps.current.style[prop] != value) {
          ...
          if (prop.startsWith("--")) {
            ...
            element.style[prop] = value != null ? value : "";
          }
        }
      }
    }, []);
    ...
    const setAttribute = T2((prop, value) => {
      ...
      if (value != null) {
        if (getAttribute(prop) != value) {
          ...
          (_a2 = getElement()) == null ? void 0 : _a2.setAttribute(prop, value);
        }
      } else {
        if (getAttribute(prop) != void 0) {
          delete currentImperativeProps.current.others[prop];
          (_b = getElement()) == null ? void 0 : _b.removeAttribute(prop);
        }
      }
    }, []);
  ...
  function ImperativeElementU({ tag: Tag, handle, ...props }, ref) {
    ...
    return y(Tag, useMergedProps(propsStable, iprops, props, { ref }));
  }
  var EventMapping = {
    abort: "onAbort",
  ...
  function generateRandomId(prefix) {
    return `${prefix != null ? prefix : "id-"}${random64Bits().map((n2) => base64(n2)).join("")}`;
  }
  ...
  function usePortalChildren({ target }) {
    ...
    const pushChildStable = useStableCallback((child) => {
      var _a2;
      return (_a2 = pushChild == null ? void 0 : pushChild(child)) != null ? _a2 : -1;
    });
    const updateChildStable = useStableCallback((index, child) => {
      return updateChild == null ? void 0 : updateChild(index, child);
    });
    const removeChildStable = useStableCallback((index) => {
      return removeChild == null ? void 0 : removeChild(index);
    });
    const element = F2(() => {
      return target == null ? null : typeof target == "string" ? document.getElementById(target) : target;
    }, [target]);
    const children = !element ? null : z3(o3(PortalChildren, { setPushChild, setUpdateChild, setRemoveChild }), element);
    return {
      children,
  ...
  function PortalChildren({ setPushChild, setUpdateChild, setRemoveChild }) {
    ...
    const updateChild = T2((index, child) => {
      var _a2;
      const key = (_a2 = getChildren()[index]) == null ? void 0 : _a2.key;
      console.assert(key);
      if (key) {
        setChildren((prev) => {
  ...
  function useElementSize({ elementSizeParameters: { getObserveBox, onSizeChange }, refElementParameters }) {
    ...
    const { refElementReturn, ...rest } = useRefElement({
      refElementParameters: {
        onElementChange: T2((e3, p3) => {
          needANewObserver(e3, getObserveBox == null ? void 0 : getObserveBox());
          onElementChange == null ? void 0 : onElementChange(e3, p3);
        }, []),
        onMount,
        onUnmount
      }
    ...
    const { activeElementReturn } = useActiveElement({
      activeElementParameters: {
        onLastActiveElementChange: T2((lastActiveElement, prevLastActiveElement, e3) => {
          ...
          const focusedInner = !!(selfElement == null ? void 0 : selfElement.contains(lastActiveElement));
          setLastFocused(focused, e3);
          setLastFocusedInner(focusedInner, e3);
          onLastActiveElementChange == null ? void 0 : onLastActiveElementChange(lastActiveElement, prevLastActiveElement, e3);
        }, []),
        ...activeElementParameters
      }
    });
  ...
  function useAnimationFrame({ callback }) {
    ...
    const stableCallback = useStableCallback(callback != null ? callback : noop_default);
  ...
  var DemoUseGrid = x3(() => {
    ...
    const ret = useCompleteGridNavigation({
      ...
      typeaheadNavigationParameters: { collator: null, noTypeahead: false, typeaheadTimeout: 1e3 },
      rearrangeableChildrenParameters: {
    ...
    return /* @__PURE__ */ o3("div", { class: "demo", children: [
      ...
      /* @__PURE__ */ o3("table", { ...{ border: "2" }, style: { whiteSpace: "nowrap" }, children: [
        ...
        /* @__PURE__ */ o3(GridRowContext.Provider, { value: context, children: /* @__PURE__ */ o3("tbody", { ...propsStable, children: useRearrangedChildren(
          Array.from(function* () {
  ...
  var DemoUseGridRow = x3(({ index }) => {
    ...
    const ret = useCompleteGridNavigationRow({
      ...
      textContentParameters: { getText: T2((e3) => {
        var _a2;
        return (_a2 = e3 == null ? void 0 : e3.textContent) != null ? _a2 : "";
      }, []) },
  ...
  var DemoUseGridCell = ({ index, row, rowIsTabbable }) => {
    ...
    const {
      ...
      info: { index, bar: "baz", focusSelf: useStableCallback((e3) => e3.focus()), hidden: false },
      context,
      textContentParameters: { getText: T2((e3) => {
        var _a2;
        return (_a2 = e3 == null ? void 0 : e3.textContent) != null ? _a2 : "";
  ...
  // demos/use-interval.tsx
  var DemoUseInterval = () => {
    const [interval, setInterval2] = useState(1e3);
    const [fireCount, setFireCount] = useState(0);
    useInterval({ interval, callback: () => setFireCount((i3) => ++i3) });
    return /* @__PURE__ */ o3("div", { class: "demo", children: [
      /* @__PURE__ */ o3("h2", { children: "useInterval" }),
      /* @__PURE__ */ o3("p", { children: [
        "Run code every ",
        /* @__PURE__ */ o3("code", { children: "n" }),
        " milliseconds after the component mounts"
      ] }),
      /* @__PURE__ */ o3("label", { children: [
        "Interval duration: ",
        /* @__PURE__ */ o3("input", { type: "number", value: interval, onInput: (e3) => setInterval2(e3.currentTarget.valueAsNumber) })
      ] }),
      /* @__PURE__ */ o3("div", { children: [
  ...
  function DemoUseModal(props) {
    var _a2;
    const parentDepth = (_a2 = props.parentDepth) != null ? _a2 : 0;
    ...
    const focusOpener = () => {
      var _a3;
      return (_a3 = buttonRef.current) == null ? void 0 : _a3.focus();
    };
    const {
      propsStablePopup,
      propsStableSource,
      ...
      focusTrapParameters: {
        ...
        onlyMoveFocus: false,
        focusOpener,
        focusPopup: useStableCallback((e3, f3) => {
          var _a3;
          return (_a3 = f3()) == null ? void 0 : _a3.focus();
        })
      },
      dismissParameters: {
        closeOnBackdrop,
    ...
    return /* @__PURE__ */ o3("div", { style: { border: `${depth}px solid black` }, children: [
      ...
      /* @__PURE__ */ o3("div", { children: [
        ...
        closeReason != null ? closeReason : "(hasn't been closed yet)"
      ] }),
  ...
  var DemoUseRovingTabIndex = x3(() => {
    ...
    if (!isFinite(min != null ? min : NaN))
      min = null;
    if (!isFinite(max != null ? max : NaN))
      max = null;
    ...
    const jsxChildren = Array.from(function* () {
      for (let i3 = 0; i3 < count; ++i3) {
        yield /* @__PURE__ */ o3(DemoUseRovingTabIndexChild, { index: i3 }, i3);
      }
    }());
    return /* @__PURE__ */ o3("div", { className: "demo", children: [
      ...
      /* @__PURE__ */ o3("label", { children: [
        ...
        /* @__PURE__ */ o3("input", { type: "number", onInput: (e3) => {
          e3.preventDefault();
          setSelectedIndex(e3.currentTarget.valueAsNumber);
        } }),
        " (currently ",
        selectedIndex,
        ")"
      ...
      /* @__PURE__ */ o3("label", { children: [
        ...
        /* @__PURE__ */ o3("input", { type: "number", value: min != null ? min : void 0, min: 0, max: max != null ? max : void 0, onInput: (e3) => {
          e3.preventDefault();
      ...
      /* @__PURE__ */ o3("label", { children: [
        ...
        /* @__PURE__ */ o3("input", { type: "number", value: max != null ? max : void 0, min: min != null ? min : void 0, max: count, onInput: (e3) => {
          e3.preventDefault();
      ...
      /* @__PURE__ */ o3("label", { children: [
        "Selection mode:",
        /* @__PURE__ */ o3("label", { children: [
          /* @__PURE__ */ o3("input", { name: "rti-demo-selection-mode", type: "radio", checked: selectionMode == "focus", onInput: (e3) => {
            e3.preventDefault();
        ...
        /* @__PURE__ */ o3("label", { children: [
          /* @__PURE__ */ o3("input", { name: "rti-demo-selection-mode", type: "radio", checked: selectionMode == "activation", onInput: (e3) => {
            e3.preventDefault();
      ...
      /* @__PURE__ */ o3(ListNavigationSingleSelectionChildContext.Provider, { value: context, children: /* @__PURE__ */ o3("ol", { start: 0, ...propsStable, children: useRearrangedChildren(jsxChildren) }) }),
      /* @__PURE__ */ o3("div", { children: [
        "Typeahead status: ",
        typeaheadStatus
      ] })
  ...
  var DemoUseRovingTabIndexChild = x3(({ index }) => {
    if (index == 1)
      return /* @__PURE__ */ o3("li", { children: [
        "(Item ",
        index,
        " is a ",
    ...
    return /* @__PURE__ */ o3("li", { ...props2, style: { opacity: hideBecausePaginated ? 0.25 : 1, transform: `translateX(${hideBecauseStaggered ? "50%" : "0%"})` }, children: [
      text,
      /* @__PURE__ */ o3("input", { ...useMergedProps({ type: "number", tabIndex: props.tabIndex }), style: { width: "5ch" } })
    ] });
  });
  ...
  var DemoUseDroppable = () => {
    ...
    const { ref: _ref } = useMergedProps({}, { ref: _2(null) });
    ...
    return /* @__PURE__ */ o3("div", { ...p3, children: [
      ...
      droppedFiles != null && /* @__PURE__ */ o3("div", { children: [
        ...
        /* @__PURE__ */ o3("table", { children: [
          ...
          /* @__PURE__ */ o3("tbody", { children: droppedFiles.map((f3) => {
            var _a2;
            return /* @__PURE__ */ o3("tr", { children: [
              /* @__PURE__ */ o3("td", { children: f3.name }),
              f3.data.byteLength,
              /* @__PURE__ */ o3("td", { children: f3.type }),
              /* @__PURE__ */ o3("td", { children: new Date((_a2 = f3.lastModified) != null ? _a2 : 0) })
            ] });
          }) })
        ] })
      ] }),
  ...
  var ChildrenHaveFocusContext = F(null);
  ...
  var DemoUseElementSizeAnimation = () => {
    ...
    const { propsStable } = useElementSize({
      elementSizeParameters: { onSizeChange: setElementSize, getObserveBox: null },
      refElementParameters: { onElementChange: void 0 }
    });
    return /* @__PURE__ */ o3("div", { style: "height: 300px; width: 300px; contain: strict;", children: /* @__PURE__ */ o3("div", { ...useMergedProps(propsStable, { ref: void 0, className: "demo", style: { height: `${height * 100 + 100}px` } }), children: /* @__PURE__ */ o3("pre", { children: JSON.stringify(elementSize, null, 2) }) }) });
  };
  var DemoUseFocusTrap = x3(({ depth }) => {
    const [active, setActive] = useState(false);
    const { propsStable, refElementReturn } = useRefElement({});
    const { props, focusTrapReturn } = useFocusTrap({
      focusTrapParameters: {
        trapActive: active,
        onlyMoveFocus: false,
        focusOpener: (e3) => e3 == null ? void 0 : e3.focus(),
        focusPopup: (e3, f3) => {
          var _a2;
          return (_a2 = f3()) == null ? void 0 : _a2.focus();
        }
      },
      refElementReturn
    });
    ...
    return /* @__PURE__ */ o3("div", { className: "demo", children: [
      ...
      /* @__PURE__ */ o3("div", { ...divProps, children: /* @__PURE__ */ o3(DemoUseFocusTrapChild, { active, setActive, depth: depth != null ? depth : 0 }) })
    ] });
  });
  ...
  var DemoUseAsyncHandler1 = x3(() => {
    ...
    const {
      ...
      rejectCount,
      resolveCount
    } = useAsyncHandler({ asyncHandler: asyncOnClick, capture: () => {
  ...
  var DemoFocus = x3(() => {
    ...
    return /* @__PURE__ */ o3("div", { class: "demo", children: [
      ...
      /* @__PURE__ */ o3("div", { children: /* @__PURE__ */ o3("ul", { children: [
        ...
        /* @__PURE__ */ o3("li", { children: [
          "activeElement: ",
          activeElement == null ? void 0 : activeElement.textContent
        ] }),
        /* @__PURE__ */ o3("li", { children: [
          "lastActiveElement: ",
          lastActiveElement == null ? void 0 : lastActiveElement.textContent
        ] })
      ] }) })
    ] });
  });
  ...
  function DemoPress({ remaining }) {
    ...
    return /* @__PURE__ */ o3("div", { className: "demo", children: [
      ...
      /* @__PURE__ */ o3("div", { children: [
        "Long press: ",
        (longPress != null ? longPress : "null").toString()
      ] }),
  ...
  function DemoGlobalHandler() {
    ...
    return /* @__PURE__ */ o3("div", { className: "demo", children: [
      ...
      /* @__PURE__ */ o3("button", { id: "global-handler-test", onClick: () => {
        ...
        (_a2 = document.getElementById("global-handler-test2")) == null ? void 0 : _a2.click();
  ...
  var DemoGlobalHandlerChildren = x3(function DemoGlobalHandlerChildren2({ count, mode }) {
    return /* @__PURE__ */ o3(_, { children: [...function* () {
      for (let i3 = 0; i3 < count; ++i3) {
  ...
  var DemoGlobalHandlerChild = x3(function DemoGlobalHandlerChild2({ mode, target }) {
    useGlobalHandler(target, "click", mode == null ? null : (e3) => {
      var _a2;
      if (((_a2 = e3.target) == null ? void 0 : _a2.id) != "global-handler-test2")
        return;
  ...
  var DemoStaggeredChild = x3(({ index }) => {
    ...
    const { info: { setParentIsStaggered, setStaggeredVisible }, props, staggeredChildReturn: { hideBecauseStaggered, isStaggered } } = useStaggeredChild({ context, info: { index } });
    const { managedChildReturn } = useManagedChild({ context, info: { hidden: false, index, setParentIsStaggered, setStaggeredVisible } });
    return /* @__PURE__ */ o3("div", { ...useMergedProps(props, { style: hideBecauseStaggered ? { opacity: 0.25 } : {} }), children: [
      "Child #",
      index,
      isStaggered ? hideBecauseStaggered ? "(pending)" : "" : "(not staggered)"
    ] });
  });
  var Component = () => {
    return /* @__PURE__ */ o3("div", { class: "flex", style: { flexWrap: "wrap" }, children: [
      ...
      /* @__PURE__ */ o3("hr", {}),
      /* @__PURE__ */ o3(DemoUseElementSizeAnimation, {}),
      /* @__PURE__ */ o3("hr", {}),
      /* @__PURE__ */ o3("input", {})
    ] });
  };
  requestAnimationFrame(() => {
    B(/* @__PURE__ */ o3(Component, {}), document.getElementById("root"));
  });
})();
