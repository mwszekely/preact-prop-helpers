var bundle = (function (exports) {
    ...
    function identity$2(t) { return t; } // Kind of an extra, but it's useful in other places anyway
    /**
    ...
    */
    ...
    function useSingleSelectionChild(args) {
        ...
        return {
            ...
            singleSelectionChildReturn: {
                ...
                getSelected,
                propsUnstable: ariaPropName == null || selectionMode == "disabled" ? {} : { [ariaPropName]: (selected ?? false).toString() }
            },
    ...
    const DemoUseRovingTabIndex = R(() => {
        ...
        const { props, context, rovingTabIndexReturn: { setTabbableIndex }, singleSelectionReturn: { changeSelectedIndex }, managedChildrenReturn: { getChildren }, typeaheadNavigationReturn: { invalidTypeahead }, rearrangeableChildrenReturn: { useRearrangedChildren, shuffle }
