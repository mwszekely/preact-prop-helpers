        ...
        return function ({ capture, debounce }) {
            ...
            function wantToStartANewPromise(startPromise) {
                ...
                let startPromiseWithBoilerplate = () => {
                    ...
                    const onCatch = (ex) => { setError(ex); setHasError(true); setHasCapture(false); setCurrentCapture(undefined); setRejectCount(c => ++c); };
