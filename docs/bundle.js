...
(() => {
  ...
  function useRearrangedChildren({ rearrangedChildrenParameters: { children, forceUpdateRef, getIndex, ...void2 }, rearrangeableChildrenReturn: { indexMangler, ...void3 }, managedChildrenReturn: { getChildren, ...void4 }, ...void1 }) {
    ...
    const sortedChildren = F5(() => {
      return children.slice().map((child) => ({ child, mangledIndex: indexMangler(getIndex(child)), demangledIndex: getIndex(child) })).sort((lhs, rhs) => {
        ...
        return y3(child.type, { ...child.props, key: demangledIndex });
      });
    }, [children]);
  ...
  var DemoUseRovingTabIndex = x3(() => {
    ...
    const {
      ...
      rearrangeableChildrenReturn: { useRearrangedChildren: useRearrangedChildren2, shuffle: shuffle2, reverse }
    ...
    return /* @__PURE__ */ o5("div", { className: "demo", children: [
      ...
      /* @__PURE__ */ o5(UntabbableContext.Provider, { value: untabbable, children: /* @__PURE__ */ o5(SingleSelectionModeContext.Provider, { value: singleSelectionMode, children: /* @__PURE__ */ o5(MultiSelectionModeContext.Provider, { value: multiSelectionMode, children: /* @__PURE__ */ o5(ListNavigationSingleSelectionChildContext.Provider, { value: context, children: /* @__PURE__ */ o5("ol", { start: 0, ...props, children: useRearrangedChildren2(jsxChildren) }) }) }) }) })
    ] });
  });
