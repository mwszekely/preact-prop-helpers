...
var bundle = function (exports) {
  ...
  */
   ...
   */
  function useRovingTabIndex(_ref14) {
    let {
      managedChildrenReturn: {
        getChildren
      },
  ...
  function useRovingTabIndexChild(_ref15) {
    let {
      managedChildParameters: {
        index,
        ..._void2
  ...
  function useTextContent(_ref16) {
    let {
      refElementReturn: {
        getElement
      },
   ...
   * @see useListNavigation, which packages everything up together.
   */
  function useTypeaheadNavigation(_ref17) {
    let {
  ...
  function useTypeaheadNavigationChild(_ref18) {
    let {
      managedChildParameters: {
        index,
        ...void1
   ...
   */
  function useListNavigation(_ref19) {
    let {
      linearNavigationParameters,
      typeaheadNavigationParameters,
      rovingTabIndexParameters,
  ...
  function useGridNavigation(_ref21) {
    let {
  ...
  function useGridNavigationRow(_ref22) {
    let {
  ...
  function useGridNavigationCell(_ref23) {
    let {
  ...
  function useSingleSelection(_ref24) {
    let {
      managedChildrenReturn: {
        getChildren
      },
  ...
  function usePaginatedChildren(_ref33) {
    let {
      managedChildrenReturn,
      linearNavigationParameters: {
        indexDemangler,
    ...
    const refreshPagination = useStableCallback(() => {
      ...
      for (let i = 0; i <= childMax; ++i) {
        var _managedChildrenRetur, _managedChildrenRetur2, _managedChildrenRetur3;
        ...
        (_managedChildrenRetur = managedChildrenReturn.getChildren().getAt(indexDemangler(i))) === null || _managedChildrenRetur === void 0 ? void 0 : _managedChildrenRetur.setParentIsPaginated(parentIsPaginated);
        (_managedChildrenRetur2 = managedChildrenReturn.getChildren().getAt(indexDemangler(i))) === null || _managedChildrenRetur2 === void 0 ? void 0 : _managedChildrenRetur2.setPaginationVisible(visible);
        (_managedChildrenRetur3 = managedChildrenReturn.getChildren().getAt(indexDemangler(i))) === null || _managedChildrenRetur3 === void 0 ? void 0 : _managedChildrenRetur3.setChildCountIfPaginated(managedChildrenReturn.getChildren().getHighestIndex() + 1);
      }
    });
    s(() => {
      refreshPagination();
        ...
        onChildCountChange: useStableCallback(count => {
          if (paginationMax != null || paginationMin != null) {
            ...
            for (let i = min; i < max; ++i) {
              var _managedChildrenRetur4, _managedChildrenRetur5;
  ...
  function usePaginatedChild(_ref34) {
    let {
      managedChildParameters: {
        index
      },
  ...
  function useChildrenHaveFocusChild(_ref35) {
    let {
  ...
  function useCompleteGridNavigation(_ref36) {
    let {
      gridNavigationParameters,
      linearNavigationParameters,
      rovingTabIndexParameters,
    ...
    const getDefaultPaginationVisible = useStableCallback(i => {
      var _paginatedChildrenPar, _paginatedChildrenPar2;
      return i >= ((_paginatedChildrenPar = paginatedChildrenParameters.paginationMin) !== null && _paginatedChildrenPar !== void 0 ? _paginatedChildrenPar : -Infinity) && i < ((_paginatedChildrenPar2 = paginatedChildrenParameters.paginationMax) !== null && _paginatedChildrenPar2 !== void 0 ? _paginatedChildrenPar2 : Infinity);
    });
    const context = useStableObject({
      ...
      childrenHaveFocusChildContext,
      gridNavigationRowContext,
      paginatedChild: useStableObject({
        getDefaultPaginationVisible
      })
    });
    return {
  ...
  function useCompleteGridNavigationRow(_ref37) {
    let {
      rowAsChildOfGridParameters: {
        managedChildParameters,
        context: {
    ...
    s(() => {
      setPaginationVisible(getDefaultPaginationVisible(index));
    }, [index]);
  ...
  function useCompleteGridNavigationCell(_ref38) {
    let {
      gridNavigationCellParameters,
      managedChildParameters,
      context: {
   ...
   * @returns
   */
  function useCompleteListNavigation(_ref40) {
    let {
      linearNavigationParameters,
      rearrangeableChildrenParameters,
      sortableChildrenParameters,
    ...
    const props = useMergedProps(linearNavigationReturn.propsStable, typeaheadNavigationReturn.propsStable);
    const getDefaultPaginationVisible = useStableCallback(i => {
      var _paginatedChildrenPar3, _paginatedChildrenPar4;
      return i >= ((_paginatedChildrenPar3 = paginatedChildrenParameters.paginationMin) !== null && _paginatedChildrenPar3 !== void 0 ? _paginatedChildrenPar3 : -Infinity) && i < ((_paginatedChildrenPar4 = paginatedChildrenParameters.paginationMax) !== null && _paginatedChildrenPar4 !== void 0 ? _paginatedChildrenPar4 : Infinity);
    });
    const context = useStableObject({
      singleSelectionContext,
      managedChildContext,
  ...
  function useCompleteListNavigationChild(_ref41) {
    let {
    ...
    hidden || (hidden = !paginatedVisible);
    let {
      disabled
    } = singleSelectionChildParameters;
    ...
    const props = useMergedProps(refElementReturn.propsStable, pressReturn.propsUnstable, hasCurrentFocusReturn.propsStable, rovingTabIndexChildReturn.propsUnstable, singleSelectionChildReturn.propsUnstable, paginationProps);
    return {
      props,
      pressReturn,
      rovingTabIndexChildReturn,
   ...
   */
  function useRandomDualIds(_ref44) {
    let {
   ...
   */
  function useAsyncHandler(_ref46) {
    let {
      asyncHandler,
  ...
  const DemoUseRovingTabIndexChild = R(_ref50 => {
    let {
      index
    } = _ref50;
    ...
    return o$1("div", {
      ...
      children: [droppedStrings != null && o$1("div", {
        children: ["Data dropped: ", o$1("ul", {
          children: Object.entries(droppedStrings).map(_ref51 => {
            let [type, value] = _ref51;
            return o$1("li", {
              children: [type, ": ", value]
            });
          })
  ...
  const DemoUseChildrenHaveFocusChild = _ref52 => {
    let {
      index
    } = _ref52;
    const {
  ...
  const DemoUseFocusTrap = R(_ref53 => {
    let {
      depth
    } = _ref53;
  ...
  const DemoUseFocusTrapChild = R(_ref54 => {
    let {
      setActive,
      active
    } = _ref54;
