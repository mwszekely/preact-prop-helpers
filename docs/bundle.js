var bundle = (function (exports, usePassiveState$1) {
    'use strict';
    ...
    */
    ...
    function useRefElement({ onElementChange }) {
        ...
        const [getElement, setElement] = usePassiveState$1.usePassiveState(onElementChange, null);
    ...
    function useElementSize({ observeBox, setSize }) {
        const { getElement, useRefElementProps } = useRefElement({ onElementChange: e => {
            } });
