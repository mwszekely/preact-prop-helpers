var bundle = (function (exports) {
    ...
    */
    ...
    function forEachUpdater(element, map, value) {
    ...
    function focusout(e) {
        if (e.relatedTarget == null) {
            forEachUpdater(e.target, activeElementUpdaters, null);
        }
    }
    function focusin(e) {
        e.target.ownerDocument.defaultView;
        let currentlyFocusedElement = e.target;
        forEachUpdater(e.target, activeElementUpdaters, currentlyFocusedElement);
        forEachUpdater(e.target, lastActiveElementUpdaters, currentlyFocusedElement);
    }
    function windowFocus(e) {
        const window = (e.target instanceof Window ? e.target : e.currentTarget instanceof Window ? e.currentTarget : e.target.ownerDocument.defaultView);
        windowsFocused.set(window, true);
        forEachUpdater(e.target, windowFocusedUpdaters, true);
    }
    function windowBlur(e) {
        const window = (e.target instanceof Window ? e.target : e.currentTarget instanceof Window ? e.currentTarget : e.target.ownerDocument.defaultView);
        windowsFocused.set(window, false);
        forEachUpdater(e.target, windowFocusedUpdaters, false);
    }
    /**
