(function () {
	...
	*/
	...
	function useActiveElement() {
	    ...
	    const wfTrue = A$1(() => { setWindowFocused(true); }, []);
	    const wfFalse = A$1(() => { setWindowFocused(false); }, []);
	    h(() => {
	        const F = () => setI(i => ++i);
	        if (updaters.size === 0) {
