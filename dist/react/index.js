import { useRef, useCallback, useLayoutEffect, useInsertionEffect, useMemo, useEffect, useState as useState$1, createElement, Fragment, useId, memo, forwardRef, useImperativeHandle, cloneElement, createContext, useContext } from 'react';
...
import { debounce, identity, noop, shuffle } from 'lodash-es';
...
const $onElementChange = Symbol();
const $onMount = Symbol();
const $onUnmount = Symbol();
const $refElementParameters = Symbol();
const $refElementReturn = Symbol();
...
const $dismissBackdropActive = Symbol();
const $onDismissBackdrop = Symbol();
const $backdropDismissParameters = Symbol();
const $refElementPopupReturn = Symbol();
/**
 * Handles events for a backdrop on a modal dialog -- the kind where the user expects the modal to close when they click/tap outside of it.
 *
 * @compositeParams
 */
const useBackdropDismiss = monitored(function useBackdropDismiss({ [$backdropDismissParameters]: { [$dismissBackdropActive]: open, [$onDismissBackdrop]: onCloseUnstable, ...void1 }, [$refElementPopupReturn]: { [$getElement]: getElement, ...void3 }, ...void2 }) {
...
const $onActiveElementChange = Symbol();
const $onLastActiveElementChange = Symbol();
const $onWindowFocusedChange = Symbol();
const $getDocument = Symbol();
const $activeElementReturn = Symbol();
const $activeElementParameters = Symbol();
const $getActiveElement = Symbol();
const $getLastActiveElement = Symbol();
const $getWindowFocused = Symbol();
 ...
 * @compositeParams
 */
const useActiveElement = monitored(function useActiveElement({ [$activeElementParameters]: { [$onActiveElementChange]: onActiveElementChange, [$onLastActiveElementChange]: onLastActiveElementChange, [$onWindowFocusedChange]: onWindowFocusedChange, [$getDocument]: getDocument } }) {
...
const $onDismissEscape = Symbol();
const $dismissEscapeActive = Symbol();
const $parentDepth = Symbol();
const $escapeDismissParameters = Symbol();
 ...
 * @compositeParams
 */
const useEscapeDismiss = monitored(function useEscapeDismiss({ [$escapeDismissParameters]: { [$onDismissEscape]: onClose, [$dismissEscapeActive]: open, [$getDocument]: unstableGetDocument, [$parentDepth]: parentDepth2, ...void1 }, [$refElementPopupReturn]: { [$getElement]: getElement, ...void2 } }) {
...
const $onDismissLostFocus = Symbol();
const $dismissLostFocusActive = Symbol();
const $lostFocusDismissParameters = Symbol();
const $refElementSourceReturn = Symbol();
/**
 ...
 * @compositeParams
 */
const useLostFocusDismiss = monitored(function useLostFocusDismiss({ [$refElementPopupReturn]: { [$getElement]: getPopupElement, ...void3 }, [$refElementSourceReturn]: refElementSourceReturn, [$lostFocusDismissParameters]: { [$dismissLostFocusActive]: open, [$onDismissLostFocus]: onClose, ...void4 }, ...void1 }) {
...
const $debouncingSync = Symbol();
const $debouncingAsync = Symbol();
const $callCount = Symbol();
const $settleCount = Symbol();
const $resolveCount = Symbol();
const $rejectCount = Symbol();
const $result = Symbol();
const $hasResult = Symbol();
const $error = Symbol();
const $hasError = Symbol();
const $invocationResult = Symbol();
const $flushDebouncedPromise = Symbol();
const $syncHandler = Symbol();
...
const $asyncHandler = Symbol();
const $currentCapture = Symbol();
const $getCurrentCapture = Symbol();
const $hasCapture = Symbol();
/**
 ...
 */
const useAsyncHandler = monitored(function useAsyncHandler({ [$asyncHandler]: asyncHandler, [$capture]: originalCapture, ...restAsyncOptions }) {
...
const $pressParameters = Symbol();
const $onPressingChange = Symbol();
const $onPressSync = Symbol();
const $excludeSpace = Symbol();
const $excludeEnter = Symbol();
const $excludePointer = Symbol();
const $focusSelf = Symbol();
const $allowRepeatPresses = Symbol();
const $longPressThreshold = Symbol();
const $pressing = Symbol();
const $getIsPressing = Symbol();
const $longPress = Symbol();
const $asyncHandlerParameters = Symbol();
const $asyncHandlerReturn = Symbol();
...
function usePressAsync({ [$asyncHandlerParameters]: { [$debounce]: debounce, [$throttle]: throttle, [$asyncHandler]: asyncHandler }, [$pressParameters]: pressParameters, [$refElementReturn]: refElementReturn }) {
...
const $getText = Symbol();
const $onTextContentChange = Symbol();
const $textContentParameters = Symbol();
const $getTextContent = Symbol();
const $textContentReturn = Symbol();
/**
 * Allows examining the rendered component's text content whenever it renders and reacting to changes.
 *
 * @compositeParams
 */
const useTextContent = (function useTextContent({ [$refElementReturn]: { [$getElement]: getElement }, [$textContentParameters]: { [$getText]: getText, [$onTextContentChange]: onTextContentChange } }) {
...
const $onCurrentFocusedChanged = Symbol();
const $onCurrentFocusedInnerChanged = Symbol();
const $hasCurrentFocusParameters = Symbol();
const $getCurrentFocused = Symbol();
const $getCurrentFocusedInner = Symbol();
const $hasCurrentFocusReturn = Symbol();
/**
...
const $managedChildrenArray = Symbol();
const $remoteULEChildMounted = Symbol();
const $onAfterChildLayoutEffect = Symbol();
const $onChildrenMountChange = Symbol();
const $onChildrenCountChange = Symbol();
const $managedChildContext = Symbol();
const $managedChildrenParameters = Symbol();
const $managedChildrenReturn = Symbol();
const $managedChildReturn = Symbol();
/**
...
const $childrenHaveFocusParameters = Symbol();
const $childrenHaveFocusReturn = Symbol();
const $childrenHaveFocusChildContext = Symbol();
const $onCompositeFocusChange = Symbol();
const $getAnyFocused = Symbol();
const $setFocusCount = Symbol();
/**
 ...
 * @compositeParams
 */
const useChildrenHaveFocusChild = monitored(function useChildrenHaveFocusChild({ context: { [$childrenHaveFocusChildContext]: { [$setFocusCount]: setFocusCount } } }) {
    return {
...
const $rovingTabIndexReturn = Symbol();
const $rovingTabIndexParameters = Symbol();
const $rovingTabIndexContext = Symbol();
const $rovingTabIndexChildReturn = Symbol();
const $onUntabbableFocus = Symbol();
const $initiallyTabbedIndex = Symbol();
const $untabbable = Symbol();
const $untabbableBehavior = Symbol();
const $onTabbableIndexChange = Symbol();
const $setTabbableIndex = Symbol();
const $getTabbableIndex = Symbol();
const $focusSelfChild = Symbol();
const $focusSelfParent2 = Symbol();
const $tabbable = Symbol();
const $getTabbable = Symbol();
const $setLocallyTabbable = Symbol();
const $getLocallyTabbable = Symbol();
const $getUntabbable = Symbol();
const $getUntabbableBehavior = Symbol();
const $parentFocusSelf = Symbol();
const $giveParentFocusedElement = Symbol();
const $getInitiallyTabbedIndex = Symbol();
const $reevaluateClosestFit = Symbol();
/**
...
const $rearrangeableChildrenContext = Symbol();
const $rearrangeableChildrenParameters = Symbol();
const $rearrangeableChildrenReturn = Symbol();
const $compare = Symbol();
const $adjust = Symbol();
const $getIndex = Symbol();
const $onRearranged = Symbol();
const $children = Symbol();
const $rearrange = Symbol();
const $shuffle = Symbol();
const $reverse = Symbol();
const $indexMangler = Symbol();
const $indexDemangler = Symbol();
const $sort = Symbol();
/**
...
const $paginatedChildrenParameters = Symbol();
const $paginationMin = Symbol();
const $paginationMax = Symbol();
const $childCount = Symbol();
const $setPaginationVisible = Symbol();
const $setChildCountIfPaginated = Symbol();
const $parentIsPaginated = Symbol();
const $hideBecausePaginated = Symbol();
const $refreshPagination = Symbol();
const $paginatedChildReturn = Symbol();
const $paginatedChildContext = Symbol();
const $paginatedChildrenReturn = Symbol();
const $getDefaultPaginationVisible = Symbol();
/**
 ...
 */
const usePaginatedChildren = monitored(function usePaginatedChildren({ [$managedChildrenReturn]: { [$getChildren]: getChildren }, [$rearrangeableChildrenReturn]: { [$indexDemangler]: indexDemangler }, [$paginatedChildrenParameters]: { [$paginationMax]: paginationMax, [$paginationMin]: paginationMin, [$childCount]: childCount }, [$rovingTabIndexReturn]: { [$getTabbableIndex]: getTabbableIndex, [$setTabbableIndex]: setTabbableIndex }, [$childrenHaveFocusReturn]: { [$getAnyFocused]: getAnyFocused } }) {
    ...
    const paginatedChildContext = useMemo(() => ({
        ...
        [$getDefaultPaginationVisible]: getDefaultPaginationVisible
    }), [parentIsPaginated]);
    ...
    return {
        context: useMemo(() => ({ [$paginatedChildContext]: paginatedChildContext }), [paginatedChildContext]),
        [$paginatedChildrenReturn]: { [$refreshPagination]: refreshPagination }
    };
});
/**
 ...
 * @compositeParams
 */
const usePaginatedChild = monitored(function usePaginatedChild({ info: { index }, context: { [$paginatedChildContext]: { [$parentIsPaginated]: parentIsPaginated, [$getDefaultPaginationVisible]: getDefaultPaginationVisible } } }) {
    ...
    return {
        ...
        [$paginatedChildReturn]: { [$parentIsPaginated]: parentIsPaginated, [$hideBecausePaginated]: parentIsPaginated ? !paginatedVisible : false },
        info: {
...
const $onNavigateLinear = Symbol();
const $isValidForLinearNavigation = Symbol();
const $pageNavigationSize = Symbol();
const $navigatePastStart = Symbol();
const $navigatePastEnd = Symbol();
const $arrowKeyDirection = Symbol();
const $disableHomeEndKeys = Symbol();
const $getHighestIndex = Symbol();
const $getLowestIndex = Symbol();
const $linearNavigationParameters = Symbol();
const $linearNavigationReturn = Symbol();
/**
...
const $typeaheadNavigationParameters = Symbol();
const $typeaheadNavigationReturn = Symbol();
const $typeaheadNavigationContext = Symbol();
const $getCurrentTypeahead = Symbol();
const $typeaheadStatus = Symbol();
const $sortedTypeaheadInfo = Symbol();
const $insertingComparator = Symbol();
const $onNavigateTypeahead = Symbol();
const $isValidForTypeaheadNavigation = Symbol();
const $collator = Symbol();
const $noTypeahead = Symbol();
const $typeaheadTimeout = Symbol();
/**
 ...
 * @compositeParams
 */
const useTypeaheadNavigationChild = monitored(function useTypeaheadNavigationChild({ info: { [$index]: index, ...void1 }, 
 ...
 * @compositeParams
 */
const useListNavigationChild = monitored(function useListNavigationChild({ info: { [$index]: index, [$untabbable]: untabbable, ...void1 }, context, [$refElementReturn]: refElementReturn, ...void2 }) {
...
const $gridNavigationRowContext = Symbol();
const $gridNavigationCellParameters = Symbol();
const $gridNavigationParameters = Symbol();
const $getRowIndex = Symbol();
const $setTabbableRow = Symbol();
const $getTabbableColumn = Symbol();
const $setTabbableColumn = Symbol();
const $setTabbableCell = Symbol();
const $onTabbableColumnChange = Symbol();
const $initiallyTabbableColumn = Symbol();
const $colSpan = Symbol();
/**
 ...
 */
const useGridNavigation = monitored(function useGridNavigation({ [$gridNavigationParameters]: { [$onTabbableColumnChange]: onTabbableColumnChange, [$initiallyTabbableColumn]: initiallyTabbableColumn, ...void3 }, [$linearNavigationParameters]: linearNavigationParameters, ...listNavigationParameters }) {
    ...
    const { [$linearNavigationReturn]: linearNavigationReturn, [$rovingTabIndexReturn]: rovingTabIndexReturn, [$typeaheadNavigationReturn]: typeaheadNavigationReturn, [$managedChildrenParameters]: managedChildrenParameters, context: { [$rovingTabIndexContext]: rovingTabIndexContext, [$typeaheadNavigationContext]: typeaheadNavigationContext }, props, ...void1 } = useListNavigation({
    ...
    const gridNavigationRowContext = useMemoObject({
        ...
        [$getTabbableColumn]: getTabbableColumn,
        [$setTabbableColumn]: setTabbableColumn
    });
    return {
        props,
        [$managedChildrenParameters]: managedChildrenParameters,
...
info: { [$index]: index, [$untabbable]: untabbable, ...void3 }, context: contextFromParent, 
// Stuff for the row as a parent of child cells
[$linearNavigationParameters]: linearNavigationParameters, [$rovingTabIndexParameters]: { [$untabbable]: rowIsUntabbableAndSoAreCells, [$initiallyTabbedIndex]: initiallyTabbedIndex, [$onTabbableIndexChange]: onTabbableIndexChange, ...void4 }, [$managedChildrenReturn]: managedChildrenReturn, [$typeaheadNavigationParameters]: typeaheadNavigationParameters, 
// Both/neither
[$refElementReturn]: refElementReturn, ...void1 }) {
    const { [$getTabbableColumn]: getTabbableColumn, [$setTabbableColumn]: setTabbableColumn, [$setTabbableRow]: setTabbableRow } = contextFromParent[$gridNavigationRowContext];
    ...
    const whenThisRowIsFocused = useStableCallback((e) => {
        const { [$getChildren]: getChildren } = managedChildrenReturn;
    ...
    const { props: propsLNC, info: { [$getLocallyTabbable]: getLocallyTabbable, [$setLocallyTabbable]: setLocallyTabbable, ...void2 }, [$hasCurrentFocusParameters]: hasCurrentFocusParameters, [$pressParameters]: pressParameters, [$rovingTabIndexChildReturn]: rovingTabIndexChildReturn, [$textContentParameters]: textContentParameters, ...void6 } = useListNavigationChild({ info: { [$index]: index, [$untabbable]: untabbable }, [$refElementReturn]: refElementReturn, context: contextFromParent });
    const allChildCellsAreUntabbable = !rovingTabIndexChildReturn[$tabbable];
    const { props: propsLN, context: contextULN, [$linearNavigationReturn]: linearNavigationReturn, [$managedChildrenParameters]: managedChildrenParameters, [$rovingTabIndexReturn]: rovingTabIndexReturn, [$typeaheadNavigationReturn]: typeaheadNavigationReturn, ...void5 } = useListNavigation({
        ...
        [$rovingTabIndexParameters]: {
            ...
            [$onUntabbableFocus]: whenThisRowIsFocused,
    ...
    const { [$setTabbableIndex]: setTabbableIndex } = rovingTabIndexReturn;
    const gridNavigationCellContext = useMemoObject({
        //allChildCellsAreUntabbable,
        [$setTabbableRow]: setTabbableRow,
    ...
    return {
        ...
        info: { [$focusSelfChild]: focusSelf, [$getLocallyTabbable]: getLocallyTabbable, [$setLocallyTabbable]: setLocallyTabbable },
 ...
 * @compositeParams
 */
const useGridNavigationCell = monitored(function useGridNavigationCell({ context: { gridNavigationCellContext: { [$getRowIndex]: getRowIndex, [$setTabbableRow]: setTabbableRow, [$getTabbableColumn]: _getCurrentColumn, [$setTabbableColumn]: setTabbableColumn, [$setTabbableCell]: setTabbableCell, ...void4 }, [$rovingTabIndexContext]: rovingTabIndexContext, [$typeaheadNavigationContext]: typeaheadNavigationContext, ...void5 }, info: { [$index]: index, [$untabbable]: untabbable, ...void7 }, [$refElementReturn]: refElementReturn, [$gridNavigationCellParameters]: { [$colSpan]: colSpan, ...void6 }, ...void1 }) {
    colSpan ??= 1;
    const { [$hasCurrentFocusParameters]: { [$onCurrentFocusedInnerChanged]: ocfic1, ...void3 }, [$rovingTabIndexChildReturn]: rovingTabIndexChildReturn, [$textContentParameters]: textContentParameters, [$pressParameters]: pressParameters, props, info: infoLs, ...void2 } = useListNavigationChild({
        info: { [$index]: index, [$untabbable]: untabbable },
        context: { [$rovingTabIndexContext]: rovingTabIndexContext, [$typeaheadNavigationContext]: typeaheadNavigationContext },
        [$refElementReturn]: refElementReturn,
    });
    return {
        info: infoLs,
...
const $staggeredChildrenParameters = Symbol();
const $staggeredChildReturn = Symbol();
const $staggeredChildrenReturn = Symbol();
const $staggeredChildContext = Symbol();
const $setStaggeredVisible = Symbol();
const $getStaggeredVisible = Symbol();
const $staggered = Symbol();
const $stillStaggering = Symbol();
const $parentIsStaggered = Symbol();
const $hideBecauseStaggered = Symbol();
const $childUseEffect = Symbol();
const $childCallsThisToTellTheParentToMountTheNextOne = Symbol();
const $getDefaultStaggeredVisible = Symbol();
const $getIntersectionObserver = Symbol();
const $setElementToIndexMap = Symbol();
/**
 ...
 */
const useStaggeredChildren = monitored(function useStaggeredChildren({ [$managedChildrenReturn]: { [$getChildren]: getChildren }, [$staggeredChildrenParameters]: { [$staggered]: staggered, [$childCount]: childCount },
 ...
 * @compositeParams
 */
const useStaggeredChild = monitored(function useStaggeredChild({ info: { [$index]: index }, 
//refElementReturn: { getElement },
...
const $processedChildrenContext = Symbol();
/**
...
const useProcessedChild = monitored(function useProcessedChild({ context, info: { [$index]: index, ...uinfo }, }) {
...
const $onSelectionChange = Symbol();
const $multiSelectionMode = Symbol();
const $multiSelectionAriaPropName = Symbol();
const $onMultiSelectChange = Symbol();
const $initiallyMultiSelected = Symbol();
const $multiSelectionDisabled = Symbol();
const $multiSelected = Symbol();
const $onMultiSelectedChange = Symbol();
const $changeMultiSelected = Symbol();
const $getMultiSelected = Symbol();
const $multiSelectionContext = Symbol();
const $multiSelectionParameters = Symbol();
const $multiSelectionReturn = Symbol();
const $multiSelectionChildParameters = Symbol();
const $multiSelectionChildReturn = Symbol();
const $multiSelectionChildDeclarativeParameters = Symbol();
const $notifyParentOfChildSelectChange = Symbol();
const $doContiguousSelection = Symbol();
const $changeAllChildren = Symbol();
const $getCtrlKeyDown = Symbol();
const $getShiftKeyDown = Symbol();
const $setSelectedFromParent = Symbol();
const $getMultiSelectionDisabled = Symbol();
/**
 ...
 */
function useMultiSelection({ [$multiSelectionParameters]: { [$onSelectionChange]: onSelectionChange, [$multiSelectionAriaPropName]: multiSelectionAriaPropName, [$multiSelectionMode]: multiSelectionMode, ...void3 }, [$managedChildrenReturn]: { [$getChildren]: getChildren, ...void1 }, [$childrenHaveFocusReturn]: { [$getAnyFocused]: getAnyFocused, ...void4 }, ...void2 }) {
 ...
 * @compositeParams
 */
function useMultiSelectionChildDeclarative({ [$multiSelectionChildDeclarativeParameters]: { [$onMultiSelectedChange]: onMultiSelectedChange, [$multiSelected]: multiSelected, ...void3 }, [$multiSelectionChildReturn]: { [$changeMultiSelected]: changeMultiSelected, ...void2 }, ...void1 }) {
...
const $singleSelectionParameters = Symbol();
const $singleSelectionDeclarativeParameters = Symbol();
const $singleSelectionReturn = Symbol();
const $singleSelectionContext = Symbol();
const $singleSelectionChildReturn = Symbol();
const $singleSelectionChildParameters = Symbol();
const $initiallySingleSelectedIndex = Symbol();
const $onSingleSelectedIndexChange = Symbol();
const $singleSelectionMode = Symbol();
const $singleSelectionAriaPropName = Symbol();
const $singleSelectionDisabled = Symbol();
const $singleSelectedIndex = Symbol();
const $changeSingleSelectedIndex = Symbol();
const $getSingleSelectedIndex = Symbol();
const $singleSelected = Symbol();
const $getSingleSelected = Symbol();
const $singleSelectedOffset = Symbol();
const $getSingleSelectedOffset = Symbol();
const $setLocalSingleSelected = Symbol();
/**
 ...
 */
function useSingleSelectionDeclarative({ [$singleSelectionReturn]: { [$changeSingleSelectedIndex]: changeSingleSelectedIndex }, [$singleSelectionDeclarativeParameters]: { [$singleSelectedIndex]: singleSelectedIndex, [$onSingleSelectedIndexChange]: onSingleSelectedIndexChange } }) {
 ...
 */
function useSelection({ [$managedChildrenReturn]: managedChildrenReturn, [$multiSelectionParameters]: multiSelectionParameters, [$childrenHaveFocusReturn]: childrenHaveFocusReturn, [$rovingTabIndexReturn]: rovingTabIndexReturn, [$singleSelectionParameters]: singleSelectionParameters }) {
 ...
 * @compositeParams
 */
function useSelectionChild({ context, info: { [$index]: index, [$untabbable]: untabbable, ...void2 }, [$singleSelectionChildParameters]: singleSelectionChildParameters, [$multiSelectionChildParameters]: multiSelectionChildParameters, ...void3 }) {
...
const $dismissParameters = Symbol();
const $dismissActive = Symbol();
const $onDismiss = Symbol();
/**
...
const $blockingElementParameters = Symbol();
/**
...
const $trapActive = Symbol();
const $onlyMoveFocus = Symbol();
const $focusPopup = Symbol();
const $focusOpener = Symbol();
const $focusTrapParameters = Symbol();
/**
 ...
 * @compositeParams
 */
const useFocusTrap = monitored(function useFocusTrap({ [$focusTrapParameters]: { [$onlyMoveFocus]: onlyMoveFocus, [$trapActive]: trapActive, [$focusPopup]: focusSelfUnstable, [$focusOpener]: focusOpenerUnstable }, [$activeElementParameters]: activeElementParameters, [$refElementReturn]: refElementReturn }) {
    ...
    const { getTop, getLastActiveWhenClosed, getLastActiveWhenOpen } = useBlockingElement({
        [$activeElementParameters]: activeElementParameters,
...
const useCompleteGridNavigation = monitored(function useCompleteGridNavigation({ [$gridNavigationParameters]: gridNavigationParameters, [$linearNavigationParameters]: linearNavigationParameters, [$rovingTabIndexParameters]: rovingTabIndexParameters, [$singleSelectionParameters]: singleSelectionParameters, [$multiSelectionParameters]: multiSelectionParameters, [$typeaheadNavigationParameters]: typeaheadNavigationParameters, [$paginatedChildrenParameters]: paginatedChildrenParameters, [$refElementParameters]: refElementParameters, ...void1 }) {
    ...
    const { [$refElementReturn]: refElementReturn, propsStable, ...void2 } = useRefElement({ [$refElementParameters]: refElementParameters });
    ...
    const { [$childrenHaveFocusParameters]: childrenHaveFocusParameters, [$managedChildrenParameters]: managedChildrenParameters, context: { [$gridNavigationRowContext]: gridNavigationRowContext, [$rovingTabIndexContext]: rovingTabIndexContext, [$singleSelectionContext]: singleSelectionContext, [$multiSelectionContext]: multiSelectionContext, [$typeaheadNavigationContext]: typeaheadNavigationContext }, props, [$rovingTabIndexReturn]: rovingTabIndexReturn, [$linearNavigationReturn]: linearNavigationReturn, [$singleSelectionReturn]: singleSelectionReturn, [$multiSelectionReturn]: multiSelectionReturn, [$typeaheadNavigationReturn]: typeaheadNavigationReturn, ...void3 } = useGridNavigationSelection({
        [$gridNavigationParameters]: gridNavigationParameters,
        [$singleSelectionParameters]: singleSelectionParameters,
        [$multiSelectionParameters]: multiSelectionParameters,
        [$paginatedChildrenParameters]: paginatedChildrenParameters,
...
const useCompleteGridNavigationRow = monitored(function useCompleteGridNavigationRow({ info: { [$index]: index, [$untabbable]: untabbable, ...customUserInfo }, context: contextIncomingForRowAsChildOfTable, [$textContentParameters]: { [$getText]: getText, [$onTextContentChange]: otcc1 }, [$linearNavigationParameters]: linearNavigationParameters, [$rovingTabIndexParameters]: rovingTabIndexParameters, [$typeaheadNavigationParameters]: typeaheadNavigationParameters, [$hasCurrentFocusParameters]: { [$onCurrentFocusedChanged]: ocfc1, [$onCurrentFocusedInnerChanged]: ocfic3, ...void5 }, [$singleSelectionChildParameters]: singleSelectionChildParameters, [$multiSelectionChildParameters]: multiSelectionChildParameters, ...void1 }) {
    ...
    const { [$refElementReturn]: refElementReturn, propsStable, ...void6 } = useRefElement({ [$refElementParameters]: {} });
    ...
    const { [$linearNavigationReturn]: linearNavigationReturn, [$managedChildrenParameters]: managedChildrenParameters, [$pressParameters]: pressParameters, [$rovingTabIndexChildReturn]: rovingTabIndexChildReturn, [$rovingTabIndexReturn]: rovingTabIndexReturn, [$singleSelectionChildReturn]: singleSelectionChildReturn, [$multiSelectionChildReturn]: multiSelectionChildReturn, [$textContentParameters]: { [$onTextContentChange]: otcc2 }, [$typeaheadNavigationReturn]: typeaheadNavigationReturn, [$hasCurrentFocusParameters]: { [$onCurrentFocusedInnerChanged]: ocfic1, ...void3 }, context: contextGNR, info: infoRowReturn, props: p3, ...void2 } = useGridNavigationSelectionRow(parameters);
    ...
    const { context: contextMC, [$managedChildrenReturn]: managedChildrenReturn } = useManagedChildren({ [$managedChildrenParameters]: managedChildrenParameters });
    const { [$managedChildReturn]: managedChildReturn, ...void4 } = useManagedChild({ context: contextIncomingForRowAsChildOfTable, info: { ...completeInfo, ...customUserInfo } });
    const context = useMemoObject({
        ...contextGNR,
        ...contextMC,
    });
 ...
 * @compositeParams
 */
const useCompleteGridNavigationCell = monitored(function useCompleteGridNavigationCell({ [$gridNavigationCellParameters]: gridNavigationCellParameters, context, [$textContentParameters]: { [$getText]: getText, [$onTextContentChange]: otcc1, ...void4 }, info: { [$focusSelfChild]: focusSelf, [$index]: index, [$untabbable]: untabbable, ...customUserInfo }, ...void1 }) {
    const { [$refElementReturn]: refElementReturn, propsStable } = useRefElement({ [$refElementParameters]: {} });
    const { [$hasCurrentFocusParameters]: hasCurrentFocusParameters, [$rovingTabIndexChildReturn]: rovingTabIndexChildReturn, [$textContentParameters]: { [$onTextContentChange]: otcc2 }, [$pressParameters]: { [$excludeSpace]: es1 }, props: propsRti, info: info2, ...void2 } = useGridNavigationSelectionCell({
    ...
    const { [$managedChildReturn]: managedChildReturn } = useManagedChild({ context, info: { ...baseInfo, ...customUserInfo } });
...
function useCompleteGridNavigationDeclarative({ [$singleSelectionDeclarativeParameters]: singleSelectionDeclarativeParameters, [$singleSelectionParameters]: singleSelectionParameters, ...normalGridNavParameters }) {
 ...
 * @compositeParams
 */
const useCompleteListNavigationChild = monitored(function useCompleteListNavigationChild({ info: { [$index]: index, [$focusSelfChild]: focusSelf, [$untabbable]: untabbable, ...customUserInfo }, // The "...info" is empty if M is the same as UCLNCI<ChildElement>.
...
function useCompleteListNavigationDeclarative({ [$singleSelectionParameters]: singleSelectionParameters, [$singleSelectionDeclarativeParameters]: singleSelectionDeclarativeParameters, ...rest }) {
...
function useCompleteListNavigationChildDeclarative({ [$multiSelectionChildParameters]: multiSelectionChildParameters, [$multiSelectionChildDeclarativeParameters]: { [$multiSelected]: multiSelected, [$onMultiSelectedChange]: onMultiSelectedChange }, info: i1, ...rest }) {
...
const $randomIdReturn = Symbol();
const $randomIdParameters = Symbol();
const $prefix = Symbol();
const $otherReferencerProp = Symbol();
const $id = Symbol();
/**
 ...
 * @compositeParams
 */
const useRandomId = monitored(function useRandomId({ [$randomIdParameters]: { [$prefix]: prefix, [$otherReferencerProp]: otherReferencerProp } }) {
...
const $randomIdInputParameters = Symbol();
const $randomIdLabelParameters = Symbol();
/**
 * While `useRandomId` allows the referencer to use the source's ID, sometimes you also want the reverse too (e.g. I `aria-label` you, you `aria-controls` me. That sort of thing).
 *
 * @compositeParams
 */
const useRandomDualIds = monitored(function useRandomDualIds({ [$randomIdInputParameters]: randomIdInputParameters, [$randomIdLabelParameters]: randomIdLabelParameters, }) {
 ...
 * @compositeParams
 */
const useImperativeProps = monitored(function useImperativeProps({ [$refElementReturn]: { [$getElement]: getElement } }) {
...
function ImperativeElementU({ tag: Tag, handle, ...props }, ref) {
    const { propsStable, [$refElementReturn]: refElementReturn } = useRefElement({ [$refElementParameters]: {} });
    const { props: imperativeProps, imperativePropsReturn: imperativeHandle } = useImperativeProps({ [$refElementReturn]: refElementReturn });
...
const $onSizeChange = Symbol();
const $getObserveBox = Symbol();
const $elementSizeParameters = Symbol();
const $getSize = Symbol();
const $elementSizeReturn = Symbol();
/**
 * Measures an element, allowing you to react to its changes in size.
 *
 * @compositeParams
 */
const useElementSize = monitored(function useElementSize({ [$elementSizeParameters]: { [$getObserveBox]: getObserveBox, [$onSizeChange]: onSizeChange }, [$refElementParameters]: refElementParameters }) {
...
const $hasLastFocusParameters = Symbol();
const $hasLastFocusReturn = Symbol();
const $onLastFocusedChanged = Symbol();
const $onLastFocusedInnerChanged = Symbol();
const $getLastFocused = Symbol();
const $getLastFocusedInner = Symbol();
/**
 ...
 */
const useLogicalDirection = monitored(function useLogicalDirection({ ...void1 }) {
...
var f=0;function u(e,t,n,o,i,u){t||(t={});var a,c,p=t;if("ref"in p)for(c in p={},t)"ref"==c?a=t[c]:p[c]=t[c];var l$1={type:e,props:p,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,constructor:void 0,__v:--f,__i:-1,__u:0,__source:i,__self:u};if("function"==typeof e&&(a=e.defaultProps))for(c in a)void 0===p[c]&&(p[c]=a[c]);return l.vnode&&l.vnode(l$1),l$1}
...
export { $active, $activeElementParameters, $activeElementReturn, $adjust, $allowRepeatPresses, $arrowKeyDirection, $asyncHandler, $asyncHandlerParameters, $asyncHandlerReturn, $attributeFilter, $attributeOldValue, $backdropDismissParameters, $blockingElementParameters, $callCount, $capture, $changeAllChildren, $changeMultiSelected, $changeSingleSelectedIndex, $characterDataOldValue, $childCallsThisToTellTheParentToMountTheNextOne, $childCount, $childUseEffect, $children, $childrenHaveFocusChildContext, $childrenHaveFocusParameters, $childrenHaveFocusReturn, $colSpan, $collator, $compare, $currentCapture, $debounce, $debouncingAsync, $debouncingSync, $disableHomeEndKeys, $dismissActive, $dismissBackdropActive, $dismissEscapeActive, $dismissLostFocusActive, $dismissParameters, $doContiguousSelection, $elementSizeParameters, $elementSizeReturn, $enabled, $error, $escapeDismissParameters, $excludeEnter, $excludePointer, $excludeSpace, $flushDebouncedPromise, $focusOpener, $focusPopup, $focusSelf, $focusSelfChild, $focusSelfParent2, $focusTrapParameters, $getActiveElement, $getAnyFocused, $getChildren, $getCtrlKeyDown, $getCurrentCapture, $getCurrentFocused, $getCurrentFocusedInner, $getCurrentTypeahead, $getDefaultPaginationVisible, $getDefaultStaggeredVisible, $getDocument, $getElement, $getHighestIndex, $getIndex, $getInitiallyTabbedIndex, $getIntersectionObserver, $getIsPressing, $getLastActiveElement, $getLastFocused, $getLastFocusedInner, $getLocallyTabbable, $getLowestIndex, $getMatches, $getMultiSelected, $getMultiSelectionDisabled, $getObserveBox, $getRowIndex, $getShiftKeyDown, $getSingleSelected, $getSingleSelectedIndex, $getSingleSelectedOffset, $getSize, $getStaggeredVisible, $getTabbable, $getTabbableColumn, $getTabbableIndex, $getTarget, $getText, $getTextContent, $getUntabbable, $getUntabbableBehavior, $getWindowFocused, $giveParentFocusedElement, $gridNavigationCellParameters, $gridNavigationParameters, $gridNavigationRowContext, $hasCapture, $hasCurrentFocusParameters, $hasCurrentFocusReturn, $hasError, $hasLastFocusParameters, $hasLastFocusReturn, $hasResult, $hideBecausePaginated, $hideBecauseStaggered, $id, $index, $indexDemangler, $indexMangler, $initiallyMultiSelected, $initiallySingleSelectedIndex, $initiallyTabbableColumn, $initiallyTabbedIndex, $insertingComparator, $invocationResult, $isValidForLinearNavigation, $isValidForTypeaheadNavigation, $linearNavigationParameters, $linearNavigationReturn, $longPress, $longPressThreshold, $lostFocusDismissParameters, $managedChildContext, $managedChildReturn, $managedChildrenArray, $managedChildrenParameters, $managedChildrenReturn, $matches, $modalParameters, $multiSelected, $multiSelectionAriaPropName, $multiSelectionChildDeclarativeParameters, $multiSelectionChildParameters, $multiSelectionChildReturn, $multiSelectionContext, $multiSelectionDisabled, $multiSelectionMode, $multiSelectionParameters, $multiSelectionReturn, $mutationObserverParameters, $navigatePastEnd, $navigatePastStart, $noTypeahead, $notifyParentOfChildSelectChange, $onActiveElementChange, $onAfterChildLayoutEffect, $onAttributes, $onCharacterData, $onChildList, $onChildrenCountChange, $onChildrenMountChange, $onCompositeFocusChange, $onCurrentFocusedChanged, $onCurrentFocusedInnerChanged, $onDismiss, $onDismissBackdrop, $onDismissEscape, $onDismissLostFocus, $onElementChange, $onLastActiveElementChange, $onLastFocusedChanged, $onLastFocusedInnerChanged, $onMount, $onMultiSelectChange, $onMultiSelectedChange, $onNavigateLinear, $onNavigateTypeahead, $onPressSync, $onPressingChange, $onRearranged, $onSelectionChange, $onSingleSelectedIndexChange, $onSizeChange, $onTabbableColumnChange, $onTabbableIndexChange, $onTextContentChange, $onUnmount, $onUntabbableFocus, $onWindowFocusedChange, $onlyMoveFocus, $otherReferencerProp, $pageNavigationSize, $paginatedChildContext, $paginatedChildReturn, $paginatedChildrenParameters, $paginatedChildrenReturn, $paginationMax, $paginationMin, $parentDepth, $parentFocusSelf, $parentIsPaginated, $parentIsStaggered, $pending, $prefix, $pressParameters, $pressing, $processedChildrenContext, $randomIdInputParameters, $randomIdLabelParameters, $randomIdParameters, $randomIdReturn, $rearrange, $rearrangeableChildrenContext, $rearrangeableChildrenParameters, $rearrangeableChildrenReturn, $reevaluateClosestFit, $refElementParameters, $refElementPopupReturn, $refElementReturn, $refElementSourceReturn, $refreshPagination, $rejectCount, $remoteULEChildMounted, $resolveCount, $result, $reverse, $rovingTabIndexChildReturn, $rovingTabIndexContext, $rovingTabIndexParameters, $rovingTabIndexReturn, $setChildCountIfPaginated, $setElementToIndexMap, $setFocusCount, $setLocalSingleSelected, $setLocallyTabbable, $setPaginationVisible, $setSelectedFromParent, $setStaggeredVisible, $setTabbableCell, $setTabbableColumn, $setTabbableIndex, $setTabbableRow, $settleCount, $shuffle, $singleSelected, $singleSelectedIndex, $singleSelectedOffset, $singleSelectionAriaPropName, $singleSelectionChildParameters, $singleSelectionChildReturn, $singleSelectionContext, $singleSelectionDeclarativeParameters, $singleSelectionDisabled, $singleSelectionMode, $singleSelectionParameters, $singleSelectionReturn, $sort, $sortedTypeaheadInfo, $staggered, $staggeredChildContext, $staggeredChildReturn, $staggeredChildrenParameters, $staggeredChildrenReturn, $stillStaggering, $subtree, $syncHandler, $tabbable, $textContentParameters, $textContentReturn, $throttle, $trapActive, $typeaheadNavigationContext, $typeaheadNavigationParameters, $typeaheadNavigationReturn, $typeaheadStatus, $typeaheadTimeout, $untabbable, $untabbableBehavior, EventDetail, EventMapping, ImperativeElement, PersistentStates, ProvideBatchedAnimationFrames, SearchParamStates, assertEmptyObject, binarySearch, debounceRendering, enableLoggingPropConflicts, enhanceEvent, findBackupFocus, findFirstFocusable, findFirstTabbable, focus, generateRandomId, generateStack, getDocument, getEventDetail, getFromLocalStorage, getTopElement, getWindow, hideCallCount, mergeFunctions, monitored, onfocusin, onfocusout, returnFalse, returnNull, returnTrue, returnUndefined, returnZero, runImmediately, setPressVibrate, storeToLocalStorage, tryNavigateToIndex, useActiveElement, useAnimationFrame, useAsync, useAsyncEffect, useAsyncHandler, useBackdropDismiss, useBlockingElement, useChildrenFlag, useChildrenHaveFocus, useChildrenHaveFocusChild, useCompleteGridNavigation, useCompleteGridNavigationCell, useCompleteGridNavigationDeclarative, useCompleteGridNavigationRow, useCompleteGridNavigationRows, useCompleteListNavigation, useCompleteListNavigationChild, useCompleteListNavigationChildDeclarative, useCompleteListNavigationChildren, useCompleteListNavigationDeclarative, useCreateProcessedChildrenContext, useDismiss, useDocumentClass, useDraggable, useDroppable, useEffectDebug, useElementSize, useEnsureStability, useEscapeDismiss, useFocusTrap, useForceUpdate, useGlobalHandler, useGridNavigation, useGridNavigationCell, useGridNavigationRow, useGridNavigationSelection, useGridNavigationSelectionCell, useGridNavigationSelectionRow, useHasCurrentFocus, useHasLastFocus, useHideScroll, useImperativeProps, useInterval, useLayoutEffectDebug, useLinearNavigation, useListNavigation, useListNavigationChild, useListNavigationSelection, useListNavigationSelectionChild, useLogicalDirection, useLostFocusDismiss, useManagedChild, useManagedChildren, useMediaQuery, useMemoObject, useMergedChildren, useMergedClasses, useMergedProps, useMergedRefs, useMergedStyles, useModal, useMultiSelection, useMultiSelectionChild, useMultiSelectionChildDeclarative, useMutationObserver, usePaginatedChild, usePaginatedChildren, usePassiveState, usePersistentState, usePortalChildren, usePress, usePressAsync, useProcessedChild, useProcessedChildren, usePropsOnChildren, useRandomDualIds, useRandomId, useRearrangeableChildren, useRefElement, useRovingTabIndex, useRovingTabIndexChild, useSearchParamState, useSearchParamStateDeclarative, useSelection, useSelectionChild, useSelectionChildDeclarative, useSelectionDeclarative, useSingleSelection, useSingleSelectionChild, useSingleSelectionDeclarative, useStableCallback, useStableGetter, useStableMergedCallback, useStack, useStaggeredChild, useStaggeredChildren, useState, useTextContent, useTimeout, useTypeaheadNavigation, useTypeaheadNavigationChild, useUrl, useWhatCausedRender };
