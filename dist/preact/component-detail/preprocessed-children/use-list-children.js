 ...
 */
export const useListChildren = monitored(function useListChildren({ rearrangeableChildrenParameters: { onRearranged, ...rearrangeableChildrenParameters }, listChildrenParameters: { children }, paginatedChildrenParameters, refElementReturn, rovingTabIndexReturn, staggeredChildrenParameters, context: { listContext: { provideManglers } } }) {
    ...
    return {
        listChildrenReturn: {
            children: _jsx(_Fragment, { children: useRearrangedChildren(children) })
        },
        rearrangeableChildrenReturn,
...
export const useListChild = monitored(function useListChild({ context, info: { index }, listChildParameters: { children: childrenIn }, refElementReturn: { getElement }, }) {
