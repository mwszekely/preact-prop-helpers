...
export declare const $dismissBackdropActive: unique symbol;
export declare const $onDismissBackdrop: unique symbol;
export declare const $backdropDismissParameters: unique symbol;
export declare const $refElementPopupReturn: unique symbol;
 ...
 * @compositeParams
 */
export declare const useBackdropDismiss: <PopupElement extends Element, B extends boolean>({ [$backdropDismissParameters]: { [$dismissBackdropActive]: open, [$onDismissBackdrop]: onCloseUnstable, ...void1 }, [$refElementPopupReturn]: { [$getElement]: getElement, ...void3 }, ...void2 }: UseBackdropDismissParameters<PopupElement, B>) => void;
