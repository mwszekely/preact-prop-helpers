...
export declare const mergeFunctions: <T extends (...args: any[]) => (void | Promise<void>), U extends (...args: any[]) => (void | Promise<void>)>(lhs: T | null | undefined, rhs: U | null | undefined) => T | U | ((...args: Parameters<T>) => Promise<[void, void]> | undefined) | null | undefined;
