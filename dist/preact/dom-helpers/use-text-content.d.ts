...
export declare const $getText: unique symbol;
export declare const $onTextContentChange: unique symbol;
export declare const $textContentParameters: unique symbol;
export declare const $getTextContent: unique symbol;
export declare const $textContentReturn: unique symbol;
 ...
 * @compositeParams
 */
export declare const useTextContent: <E extends Element>({ [$refElementReturn]: { [$getElement]: getElement }, [$textContentParameters]: { [$getText]: getText, [$onTextContentChange]: onTextContentChange } }: UseTextContentParameters<E>) => UseTextContentReturnType;
