import { ElementProps, ElementPropsAll } from "./lib.js";
import "./mode.js";
 ...
 */
export declare function useTagProps<E extends EventTarget>(props: ElementPropsAll<E>, tag: `data-${TagPropPrefices}`): ElementProps<E>;
