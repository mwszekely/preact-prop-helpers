import { $gridNavigationCellParameters, $gridNavigationParameters, $gridNavigationRowContext } from "../component-detail/keyboard-navigation/use-grid-navigation-partial.js";
...
import { $focusSelfChild, $getLocallyTabbable, $setLocallyTabbable, $untabbable, $untabbableBehavior, $getTabbable, $getTabbableIndex, $setTabbableIndex, $rovingTabIndexChildReturn, $rovingTabIndexContext, $rovingTabIndexParameters, $rovingTabIndexReturn } from "../component-detail/keyboard-navigation/use-roving-tabindex.js";
...
import { $getAnyFocused, $childrenHaveFocusChildContext, $childrenHaveFocusParameters, $childrenHaveFocusReturn, useChildrenHaveFocus } from "../observers/use-children-have-focus.js";
...
import { $index, $getChildren, $managedChildContext, $managedChildReturn, $managedChildrenParameters, $managedChildrenReturn, useManagedChild, useManagedChildren } from "../preact-extensions/use-managed-children.js";
...
export function useCompleteGridNavigationDeclarative({ [$singleSelectionDeclarativeParameters]: singleSelectionDeclarativeParameters, [$singleSelectionParameters]: singleSelectionParameters, ...normalGridNavParameters }) {
