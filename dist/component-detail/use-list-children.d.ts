import { UseManagedChildrenContext, UseManagedChildrenReturnType } from "../preact-extensions/use-managed-children.js";
import { ExtendMerge, Nullable, OmitStrong, TargetedPick, VNode } from "../util/lib.js";
...
export interface UseListChildrenReturnType<M extends UseRearrangeableChildInfo> extends OmitStrong<UseRearrangeableChildrenReturnType<M>, never>, OmitStrong<UseStaggeredChildrenReturnType, never>, OmitStrong<UsePaginatedChildrenReturnType, never> {
    ...
    context: UsePaginatedChildContext & UseStaggeredChildContext;
}
 ...
 */
export interface UseListChildrenParameters<ParentElement extends Element, TabbableChildElement extends Element, M extends UseRearrangeableChildInfo> extends TargetedPick<UseManagedChildrenReturnType<M>, "managedChildrenReturn", "getChildren">, OmitStrong<ExtendMerge<ExtendMerge<UseRearrangeableChildrenParameters<M>, UseStaggeredChildrenParameters>, UsePaginatedChildrenParameters<ParentElement, TabbableChildElement>>, "managedChildrenReturn" | "rearrangeableChildrenReturn"> {
 ...
 * @compositeParams
 */
export declare const useListChildren: <ParentElement extends Element, TabbableChildElement extends Element, M extends UseListChildInfo<TabbableChildElement>>({ rearrangeableChildrenParameters, listChildrenParameters: { children, compare: userCompare }, managedChildrenReturn: { getChildren }, paginatedChildrenParameters, refElementReturn, rovingTabIndexReturn, staggeredChildrenParameters, context: { managedChildContext } }: UseListChildrenParameters<ParentElement, TabbableChildElement, M>) => UseListChildrenReturnType<M>;
