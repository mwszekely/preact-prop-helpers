...
export const useProcessedChild = monitored(function useProcessedChild({ context, info: { index }, processedChildParameters: { children: childrenIn }, refElementReturn: { getElement }, }) {
