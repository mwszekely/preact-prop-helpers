...
export interface UseProcessedChildrenContext extends UseRearrangedChildrenContext {
    processedChildrenContext: Pick<UseRovingTabIndexReturnTypeSelf, "PropNames.RovingTabIndexReturn.getTabbableIndex" | "PropNames.RovingTabIndexReturn.setTabbableIndex"> & Pick<UseChildrenHaveFocusReturnTypeSelf, "PropNames.ChildrenHaveFocusReturn.getAnyFocused"> & OmitStrong<UsePaginatedChildrenParametersSelf, "PropNames.PaginatedParameters.childCount"> & OmitStrong<UseStaggeredChildrenParametersSelf, "PropNames.StaggeredParameters.childCount"> & Pick<UseManagedChildrenReturnTypeSelf<any>, "PropNames.ManagedChildrenReturn.getChildren"> & Pick<UseRefElementReturnTypeSelf<any>, "PropNames.RefElementReturn.getElement">;
}
/**
 * All of these functions **MUST** be stable across renders.
 */
export interface UseProcessedChildrenParameters<TabbableChildElement extends Element, M extends UseRearrangeableChildInfo> extends OmitStrong<UseRearrangeableChildrenParameters<M>, "PropNames.ManagedChildrenReturn.getChildren">, OmitStrong<UseStaggeredChildrenParameters, "PropNames.StaggeredParameters.childCount" | keyof UseManagedChildrenReturnTypeSelf<M>>, Pick<UseManagedChildrenParameters<M>, keyof UseManagedChildrenParametersSelf<M>>, OmitStrong<UsePaginatedChildrenParameters<TabbableChildElement>, "PropNames.PaginatedParameters.childCount" | "PropNames.RearrangeableReturn.indexDemangler"> {
 ...
 */
export declare const useProcessedChildren: <TabbableChildElement extends Element, M extends UseProcessedChildInfo<TabbableChildElement>>({ context, "PropNames.ManagedChildrenReturn.getChildren": getChildren, "PropNames.RearrangeableParameters.children": childrenUnsorted, "PropNames.RearrangeableParameters.onRearranged": onRearranged, ...args }: UseProcessedChildrenParameters<TabbableChildElement, M>) => UseProcessedChildrenReturnType<TabbableChildElement, M>;
