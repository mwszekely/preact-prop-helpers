...
export interface UseSelectionChildReturnType<ChildElement extends Element, M extends UseSelectionChildInfo<ChildElement>> extends Pick<UseHasCurrentFocusParameters<ChildElement>, "PropNames.HasCurrentFocusParameters.onCurrentFocusedInnerChanged">, OmitStrong<UseSingleSelectionChildReturnType<ChildElement, M>, "props" | "info" | "PropNames.HasCurrentFocusParameters.onCurrentFocusedInnerChanged">, OmitStrong<UseMultiSelectionChildReturnType<ChildElement, M>, "props" | "info" | "PropNames.HasCurrentFocusParameters.onCurrentFocusedInnerChanged"> {
 ...
 */
export declare function useSelection<ParentOrChildElement extends Element, ChildElement extends Element>(args: UseSelectionParameters<ParentOrChildElement, ChildElement, UseSelectionChildInfo<ChildElement>>): UseSelectionReturnType<ParentOrChildElement, ChildElement>;
/**
 *
 * @compositeParams
 */
export declare function useSelectionChild<ChildElement extends Element>({ context, info: { index, untabbable, ...void2 }, ...args }: UseSelectionChildParameters<ChildElement, UseSelectionChildInfo<ChildElement>>): UseSelectionChildReturnType<ChildElement, UseSelectionChildInfo<ChildElement>>;
