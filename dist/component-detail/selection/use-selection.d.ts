...
export interface UseSelectionChildReturnType<ChildElement extends Element, M extends UseSelectionChildInfo<ChildElement>> extends Pick<UseHasCurrentFocusParameters<ChildElement>, typeof PropNames_HasCurrentFocusParameters_onCurrentFocusedInnerChanged>, OmitStrong<UseSingleSelectionChildReturnType<ChildElement, M>, "props" | "info" | typeof PropNames_HasCurrentFocusParameters_onCurrentFocusedInnerChanged>, OmitStrong<UseMultiSelectionChildReturnType<ChildElement, M>, "props" | "info" | typeof PropNames_HasCurrentFocusParameters_onCurrentFocusedInnerChanged> {
...
export declare function useSelectionDeclarative<ChildElement extends Element>(args: UseSelectionDeclarativeParameters<ChildElement>): {
    "PropNames.SingleSelectionParameters.onSingleSelectedIndexChange": import("./use-single-selection.js").SelectedIndexChangeHandler;
};
