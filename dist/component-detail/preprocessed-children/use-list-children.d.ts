...
import { ElementProps, OmitStrong, TargetedOmit, VNode } from "../../util/lib.js";
...
import { UseRearrangeableChildInfo, UseRearrangeableChildrenParameters, UseRearrangeableChildrenReturnType, UseRearrangeableChildrenReturnTypeSelf } from "./use-rearrangeable-children.js";
...
export declare const useListChild: <TabbableChildElement extends Element>({ context, info: { index }, listChildParameters: { children: childrenIn }, refElementReturn: { getElement }, }: UseListChildParameters<TabbableChildElement, UseListChildInfo<TabbableChildElement>>) => UseListChildReturnType<TabbableChildElement, UseListChildInfo<TabbableChildElement>>;
