...
import { useMergedProps, usePropsOnChildren } from "../index.js";
import { useManagedChild } from "../preact-extensions/use-managed-children.js";
 ...
 * @compositeParams
 */
export const useListChildren = monitored(function useListChildren({ rearrangeableChildrenParameters, listChildrenParameters: { children, compare: userCompare }, managedChildrenReturn: { getChildren }, paginatedChildrenParameters, refElementReturn, rovingTabIndexReturn, staggeredChildrenParameters, context: { managedChildContext } }) {
    const getCompare = useStableGetter(userCompare ?? defaultCompare);
    const { rearrangeableChildrenReturn } = useRearrangeableChildren2({ rearrangeableChildrenParameters, managedChildrenReturn: { getChildren } });
