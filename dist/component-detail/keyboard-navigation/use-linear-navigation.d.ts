...
export interface UseLinearNavigationParameters<ParentOrChildElement extends Element, ChildElement extends Element> extends UseLinearNavigationParametersSelf<ChildElement>, Pick<UseRovingTabIndexReturnType<ParentOrChildElement, ChildElement>, "PropNames.RovingTabIndexReturn.getTabbableIndex" | "PropNames.RovingTabIndexReturn.setTabbableIndex">, Pick<UseRearrangeableChildrenReturnTypeSelf<any>, "PropNames.RearrangeableReturn.indexMangler" | "PropNames.RearrangeableReturn.indexDemangler">, Pick<UsePaginatedChildrenParametersSelf, "PropNames.PaginatedParameters.paginationMin" | "PropNames.PaginatedParameters.paginationMax"> {
}
