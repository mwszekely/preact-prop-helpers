...
export function useGridNavigationSingleSelectionRow({ info: mcp1, singleSelectionChildParameters, linearNavigationParameters, managedChildrenReturn, refElementReturn, rovingTabIndexChildParameters, rovingTabIndexParameters, textContentParameters, typeaheadNavigationParameters, context: { gridNavigationRowContext, rovingTabIndexContext, singleSelectionContext, typeaheadNavigationContext }, ..._void1 }) {
    ...
    const { hasCurrentFocusParameters: { onCurrentFocusedInnerChanged: ocfic1 }, info: mcp2, props: propsSS, singleSelectionChildReturn } = useSingleSelectionChild({ info: mcp1, singleSelectionChildParameters, context: { singleSelectionContext } });
