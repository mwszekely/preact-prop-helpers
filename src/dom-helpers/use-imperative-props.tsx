 ...
 * @compositeParams
 */
export const useImperativeProps = /*@__PURE__*/ monitored(function useImperativeProps<E extends Element>({ refElementReturn: { getElement } }: UseImperativePropsParameters<E>): UseImperativePropsReturnType<E> {
