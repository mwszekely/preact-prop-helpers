...
import { $getChildren, $index, $managedChildrenParameters, $managedChildrenReturn, $onChildrenMountChange, ManagedChildInfo, UseGenericChildParameters, UseManagedChildrenParameters, UseManagedChildrenReturnType, useChildrenFlag } from "../../preact-extensions/use-managed-children.js";
...
export interface UseRovingTabIndexParameters<ParentElement extends Element, TabbableChildElement extends Element, M extends UseRovingTabIndexChildInfo<TabbableChildElement>> extends
    ...
    TargetedPick<UseRefElementReturnType<ParentElement>, typeof $refElementReturn, typeof $getElement> {
...
export interface UseRovingTabIndexReturnType<ParentElement extends Element, TabbableChildElement extends Element> extends
    TargetedPick<UseManagedChildrenParameters<UseRovingTabIndexChildInfo<TabbableChildElement>>, typeof $managedChildrenParameters, typeof $onChildrenMountChange> {
...
export interface UseRovingTabIndexChildReturnType<ChildElement extends Element> extends
    TargetedPick<UseHasCurrentFocusParameters<ChildElement>, typeof $hasCurrentFocusParameters, typeof $onCurrentFocusedInnerChanged> {
...
export const useRovingTabIndex = monitored(function useRovingTabIndex<ParentElement extends Element, ChildElement extends Element>({
    ...
    [$rovingTabIndexParameters]: { [$onUntabbableFocus]: focusSelfParentUnstable, [$untabbable]: untabbable, [$untabbableBehavior]: untabbableBehavior, [$initiallyTabbedIndex]: initiallyTabbedIndex, [$onTabbableIndexChange]: onTabbableIndexChange },
    ...
    const setTabbableIndex = useStableCallback<SetTabbableIndex>((updater, reason, fromUserInteraction) => {
        ...
        return changeTabbableIndex(function returnModifiedTabbableIndex(prevIndex: number | null | undefined): number | null {
            ...
            let nextIndex = ((typeof updater === "function") ? updater(prevIndex ?? null) : updater) as M[typeof $index];
...
export const useRovingTabIndexChild = monitored(function useRovingTabIndexChild<ChildElement extends Element>({
    info: { [$index]: index, [$untabbable]: iAmUntabbable, ...void2 },
    context: { [$rovingTabIndexContext]: { [$giveParentFocusedElement]: giveParentFocusedElement, [$getUntabbable]: getParentIsUntabbable, [$getUntabbableBehavior]: getUntabbableBehavior, [$reevaluateClosestFit]: reevaluateClosestFit, [$setTabbableIndex]: setTabbableIndex, [$getInitiallyTabbedIndex]: getInitiallyTabbedIndex, [$parentFocusSelf]: parentFocusSelf } },
    [$refElementReturn]: { [$getElement]: getElement },
    ...void3
