...
export interface UseLinearNavigationParameters<ParentOrChildElement extends Element, ChildElement extends Element> extends
    TargetedPick<UseRovingTabIndexReturnType<ParentOrChildElement, ChildElement>, typeof $rovingTabIndexReturn, (typeof $getTabbableIndex) | (typeof $setTabbableIndex)>,
    TargetedPick<UseRearrangeableChildrenReturnType<any>, typeof $rearrangeableChildrenReturn, typeof $indexMangler | typeof $indexDemangler>,
    TargetedPick<UsePaginatedChildrenParameters<ChildElement>, typeof $paginatedChildrenParameters, typeof $paginationMin| typeof $paginationMax> {
...
export const useLinearNavigation = (function useLinearNavigation<ParentOrChildElement extends Element, ChildElement extends Element>({
    [$linearNavigationParameters]: { [$getLowestIndex]: getLowestIndex, [$getHighestIndex]: getHighestIndex, [$isValidForLinearNavigation]: isValidForLinearNavigation, [$navigatePastEnd]: navigatePastEnd, [$navigatePastStart]: navigatePastStart, [$onNavigateLinear]: onNavigateLinear, [$arrowKeyDirection]: arrowKeyDirection, [$disableHomeEndKeys]: disableHomeEndKeys, [$pageNavigationSize]: pageNavigationSize, ...void4 },
    [$rovingTabIndexReturn]: { [$getTabbableIndex]: getTabbableIndex, [$setTabbableIndex]: setTabbableIndex, ...void5 },
    [$paginatedChildrenParameters]: { [$paginationMax]: paginationMax, [$paginationMin]: paginationMin, ...void2 },
    [$rearrangeableChildrenReturn]: { [$indexDemangler]: indexDemangler, [$indexMangler]: indexMangler, ...void3 },
    ...void1
