...
export interface UseSingleSelectionParameters<ParentOrChildElement extends Element, ChildElement extends Element, M extends UseSingleSelectionChildInfo<ChildElement>> extends
    ...
    Pick<UseRovingTabIndexReturnType<ParentOrChildElement, ChildElement>, "PropNames.RovingTabIndexReturn.setTabbableIndex"> {
}
...
export interface SingleSelectionContextSelf extends
    RequiredN<Pick<UseSingleSelectionParametersSelf, "PropNames.SingleSelectionParameters.singleSelectionMode" | "PropNames.SingleSelectionParameters.onSingleSelectedIndexChange">>,
    Pick<UseSingleSelectionParametersSelf, "PropNames.SingleSelectionParameters.singleSelectionAriaPropName"> {
...
export interface UseSingleSelectionDeclarativeParameters<ChildElement extends Element> extends
    ...
    Pick<UseSingleSelectionReturnType<ChildElement>, "PropNames.SingleSelectionReturn.changeSingleSelectedIndex"> { }
...
export function useSingleSelectionDeclarative<ParentOrChildElement extends Element, ChildElement extends Element>({
    ...
    const osic = useCallback<NonNullable<UseSingleSelectionParametersSelf["PropNames.SingleSelectionParameters.onSingleSelectedIndexChange"]>>((e) => {
        reasonRef.current = e;
