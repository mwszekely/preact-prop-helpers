...
export type UseListNavigationSelection<ParentElement extends Element, ChildElement extends Element> = StandardHook<
...
export type UseListNavigationSelectionChild<ChildElement extends Element> = StandardHook<
