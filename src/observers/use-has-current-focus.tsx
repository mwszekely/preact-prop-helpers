...
declare module "../util/types.js" { interface PropNames { HasCurrentFocusParameters: typeof PNames } }
declare module "../util/types.js" { interface PropNames { HasCurrentFocusReturn: typeof RNames } }
