...
import { DismissListenerTypes, $dismissActive, $onDismiss, useDismiss, UseDismissParameters, UseDismissReturnType, $dismissParameters } from "../component-detail/use-dismiss.js";
import { $trapActive, useFocusTrap, UseFocusTrapParameters, $focusTrapParameters } from "../component-detail/use-focus-trap.js";
import { useMergedProps } from "../dom-helpers/use-merged-props.js";
import { $onElementChange, $onMount, $onUnmount, useRefElement, UseRefElementParameters, $refElementParameters, $refElementReturn } from "../dom-helpers/use-ref-element.js";
...
export interface UseModalParameters<Listeners extends DismissListenerTypes> extends
    ...
    OmitStrong<UseFocusTrapParameters<any, any>, typeof $refElementReturn> {
...
export const useModal = monitored(function useModal<Listeners extends DismissListenerTypes, FocusContainerElement extends Element | null, SourceElement extends Element | null, PopupElement extends Element>({
    [$dismissParameters]: { [$dismissActive]: dismissActive, [$onDismiss]: onDismiss, ...void2 },
    [$escapeDismissParameters]: { [$dismissEscapeActive]: dismissEscapeActive, [$onDismissEscape]: onDismissEscape, [$parentDepth]: parentDepth, ...void3 },
    [$focusTrapParameters]: { [$trapActive]: trapActive, ...focusTrapParameters },
    [$activeElementParameters]: { [$getDocument]: getDocument, [$onActiveElementChange]: onActiveElementChange, [$onLastActiveElementChange]: onLastActiveElementChange, [$onWindowFocusedChange]: onWindowFocusedChange, ...void4 },
    [$backdropDismissParameters]: { [$dismissBackdropActive]: dismissBackdropActive, [$onDismissBackdrop]: onDismissBackdrop, ...void5 },
    [$lostFocusDismissParameters]: { [$dismissLostFocusActive]: dismissLostFocusActive, [$onDismissLostFocus]: onDismissLostFocus, ...void6 },
    [$refElementParameters]: { [$onElementChange]: onElementChange, [$onMount]: onMount, [$onUnmount]: onUnmount, ...void7 },
    ...
    const { propsStable, [$refElementReturn]: refElementReturn } = useRefElement<NonNullable<FocusContainerElement>>({ [$refElementParameters]: { [$onElementChange]: onElementChange, [$onMount]: onMount, [$onUnmount]: onUnmount } })
